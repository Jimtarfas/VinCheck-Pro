...
const COPY = {
  ...
  fr: {
    home: "Accueil", crumb: "Vérification titre salvage",
    badge: "Recherche de titre marqué   ·   Adossée NMVTIS",
    h1Lead: "Vérification de titre salvage par VIN — ",
    h1Accent: "Le titre est-il vraiment propre ?",
    intro: "Un titre salvage signifie qu'un assureur a déjà déclaré le véhicule en perte totale — et ce statut suit le VIN à vie, même après réparations. Certains vendeurs ne le révèlent pas spontanément, et le lavage de titre peut l'effacer du titre papier. Saisis un VIN de 17 caractères pour vérifier NMVTIS et les registres DMV des 50 États — gratuit, avant d'acheter.",
    formHeading: "Effectue une vérification de titre salvage par VIN",
    formSub: "Saisis n'importe quel VIN de 17 caractères — nous ferons remonter toute marque salvage, reconstruit, inondation, ferraille ou citron au dossier",
    formNote: "Gratuit · Sans inscription · Résultat instantané",
    trustStats: [
      { icon: Database, value: "NMVTIS", label: "données adossées au DOJ" },
      { icon: Shield, value: "50 États", label: "fichiers de marques DMV" },
      { icon: BadgeCheck, value: "Permanent", label: "historique lié au VIN" },
      { icon: Zap, value: "Gratuit", label: "sans inscription" },
    ],
    h2How: "Comment fonctionne une vérification VIN de titre salvage",
    howIntro: "Les marques de titre sont suivies contre le VIN par NMVTIS et chaque DMV d'État. Trois étapes transforment cela en une image claire de la propreté réelle du titre.",
    howSteps: [
      { tag: "Étape 1", title: "Saisis le VIN", body: "Tape le VIN de 17 caractères du tableau de bord, du montant de porte, du titre ou de l'immatriculation. Les marques de titre sont liées au VIN — pas au document papier qu'un vendeur te remet." },
      { tag: "Étape 2", title: "Nous interrogeons NMVTIS + 50 États", body: "La recherche croise NMVTIS, chaque fichier de marque de titre DMV d'État et les flux de perte totale d'assureurs — les mêmes registres que le lavage de titre dans un seul État ne peut effacer." },
      { tag: "Étape 3", title: "Lis chaque marque au dossier", body: "Vois toute marque salvage, reconstruit, inondation, ferraille ou citron jamais rapportée. Une marque qui apparaît ici mais pas sur le titre papier est un signal d'alerte majeur." },
    ],
    h2What: "Que signifie réellement un titre salvage ?",
    what1Pre: "Un titre salvage est une marque de titre émise par l'État appliquée à un véhicule qu'un assureur a déterminé non économique à réparer. Cela se produit généralement lorsque les coûts de réparation dépassent un pourcentage de la ",
    what1Bold: "valeur marchande avant sinistre",
    what1Suffix: " de la voiture — un seuil qui va d'environ 50 % dans certains États à 100 % dans d'autres.",
    what2: "Une fois appliquée, la marque ne peut être effacée. Même après une reconstruction complète et une inspection réussie, le titre passe de « salvage » à « reconstruit » ou « reconstitué » — il ne redevient jamais propre. Le VIN porte cet historique à travers chaque vente future, raison pour laquelle une vérification VIN est bien plus fiable que la paperasse qu'un vendeur te remet.",
    what3: "Les véhicules salvage ont des usages légitimes — voitures pour pièces, builds pour piste, transport économique — quand l'acheteur comprend pleinement ce qu'il obtient. Le danger est d'en acheter un sans le savoir, soit par tromperie, soit parce que la voiture a été lavée à travers un État aux lois de titre plus faibles.",
    exampleTitle: "Exemple travaillé — calcul de perte totale",
    exampleRows: [
      { label: "Valeur avant sinistre", value: "$20,000" },
      { label: "Réparation estimée", value: "$15,000" },
      { label: "Ratio de réparation", value: "75% → perte totale" },
    ],
    exampleNote: "À 75 % la voiture franchit un seuil typique de perte totale de 70 à 80 %, donc l'assureur la marque salvage. Les seuils varient selon l'État — ceci est une illustration, pas une règle pour une voiture spécifique.",
    h2Brands: "Les principales marques de titre que tu devrais connaître",
    brandsIntro: "« Titre marqué » est le terme générique pour tout titre portant une désignation non propre. Chaque marque raconte une histoire différente sur ce qui est arrivé au véhicule.",
    brands: [
      { title: "Salvage", body: "Déclaré perte totale par un assureur — pas autorisé sur la route avant réparation et nouvelle inspection. Le point de départ de la plupart des titres marqués." },
      { title: "Reconstruit / Reconstitué", body: "Auparavant salvage, désormais réparé et inspecté pour usage routier. Le titre ne redevient jamais propre, et la valeur de revente chute fortement." },
      { title: "Inondation / Dégâts d'eau", body: "Submergé ou significativement endommagé par l'eau. Des problèmes électriques, de corrosion et de moisissure à long terme sont presque garantis et apparaissent pendant des années." },
      { title: "Ferraille / Non réparable", body: "Légalement ne peut être ré-immatriculé pour usage routier — apte uniquement aux pièces ou à la ferraille. Une marque ferraille ne devrait jamais apparaître sur une voiture proposée pour la route." },
      { title: "Citron / Rachat constructeur", body: "Racheté par le constructeur en raison de défauts chroniques non réparables selon les lois d'État sur les citrons. Couvert en détail sur notre page vérification citron." },
      { title: "Grêle / Feu / Vandalisme", body: "Marques de cause de sinistre utilisées dans certains États pour signaler des événements de dégâts spécifiques — contexte utile même quand les réparations ont été effectuées." },
    ],
    brandsNoteBoldLead: "Tu cherches spécifiquement un rachat ?",
    brandsNoteMid: " L'historique de citron et de rachat constructeur a sa propre couverture dédiée sur notre page ",
    brandsNoteLink: "vérification citron par VIN",
    brandsNoteSuffix: ".",
    midCtaHeading: "Cette voiture spécifique est-elle marquée ?",
    midCtaSub: "Ne te fie pas au titre papier — il peut être lavé. Lance le VIN contre NMVTIS et les 50 États pour voir chaque marque au dossier, gratuit, en quelques secondes.",
    h2Risks: "Les vrais risques d'acheter un véhicule salvage ou reconstruit",
    risksIntro: "Même un véhicule salvage bien reconstruit comporte des risques financiers et de sécurité que tu n'as tout simplement pas avec une voiture à titre propre. Pèse-les soigneusement avant de signer quoi que ce soit.",
    risks: [
      { title: "La valeur de revente chute de 20 à 40 %", body: "Un titre marqué réduit fortement la valeur marchande par rapport à une voiture équivalente à titre propre, et la marque suit le VIN à vie." },
      { title: "L'assurance est plus difficile à obtenir", body: "De nombreux assureurs n'offrent que la couverture responsabilité civile sur les titres reconstruits et refusent la couverture tous risques ou collision." },
      { title: "Le financement est limité", body: "La plupart des banques et coopératives de crédit ne consentent pas de prêt sur un titre marqué, donc les acheteurs ont souvent besoin de cash ou d'un prêteur spécialisé." },
      { title: "Dommages structurels cachés", body: "Des dommages antérieurs au châssis ou à la coque peuvent compromettre le déploiement des airbags, les performances des zones de déformation et la résistance globale aux chocs." },
    ],
    risksNoteBoldLead: "Les dégâts d'inondation sont le pire des cas.",
    risksNoteMid: " Électronique corrodée, moisissure, défaillances d'ECU et problèmes de capteurs d'airbag peuvent apparaître des années plus tard. Si une marque remonte à l'eau, fais une ",
    risksNoteLink: "vérification de dégâts d'inondation",
    risksNoteSuffix: " dédiée avant d'acheter.",
    h2Compare: "Salvage vs. reconstruit vs. propre — En un coup d'œil",
    compareIntro: "Ces trois statuts de titre comportent des droits, des risques et des résultats de revente très différents. Savoir lequel tu regardes est essentiel avant de négocier.",
    cleanTag: "Propre", cleanTitle: "Aucune marque au dossier",
    cleanBullets: ["Jamais déclaré perte totale dans aucun État.", "Options complètes d'assurance et de financement.", "Vérifie quand même par VIN — le lavage peut le truquer."],
    rebuiltTag: "Reconstruit", rebuiltTitle: "Réparé et inspecté",
    rebuiltBullets: ["Était salvage ; réparé et a passé l'inspection d'État.", "Souvent assurance responsabilité civile seulement, financement limité.", "Exige les documents de réparation et une inspection indépendante."],
    salvageTag: "Salvage", salvageTitle: "Perte totale, non réparée",
    salvageBullets: ["Pas légal à conduire avant d'être reconstruit et ré-inspecté.", "Généralement non assurable pour usage routier en l'état.", "Pour pièces, projets ou reconstruction — les yeux grands ouverts."],
    h2Washing: "Lavage de titre — Et pourquoi une vérification VIN le déjoue",
    washing1Pre: "Le lavage de titre consiste à déplacer un véhicule marqué vers un État aux lois de titre plus faibles et à le ré-immatriculer pour obtenir un titre d'apparence propre. Le papier peut indiquer ",
    washing1Bold: "« propre »,",
    washing1Suffix: " mais l'historique sous-jacent du VIN enregistre toujours chaque marque jamais appliquée, dans n'importe quel État.",
    washing2: "C'est précisément pourquoi une vérification salvage basée sur le VIN — tirant de NMVTIS et des registres DMV des 50 États — est tellement plus fiable que le document de titre lui-même. La marque suit le VIN ; la paperasse peut être échangée.",
    washing3: "NMVTIS, le Système national d'information sur les titres de véhicules motorisés, est exploité par le Département de la Justice des États-Unis. Chaque DMV d'État et chaque vente aux enchères d'assureurs auto sont tenus d'y déclarer — donc la base de données attrape les marques effacées du titre papier dans un autre État.",
    inspectCardTitle: "Liste d'inspection avant achat",
    inspectChecklist: [
      "Lance le VIN contre NMVTIS avant de rencontrer le vendeur",
      "Fais correspondre le VIN au tableau de bord, au montant de porte et au titre — les trois",
      "Surveille la peinture fraîche, les panneaux désappariés ou les traces de soudure",
      "Vérifie les tapis et les supports de sièges pour la rouille, le limon ou une odeur de moisi",
      "Exige les factures de réparation et le certificat d'État de nouvelle inspection",
      "Obtiens une inspection indépendante avant achat avant de payer",
    ],
    inspectCardCta: "Commence par le VIN — vérifie d'abord l'historique des marques :",
    h2Why: "Pourquoi une vérification salvage compte avant d'acheter",
    whyIntro: "Une marque de titre liée au VIN façonne directement ce que vaut une voiture d'occasion — et combien de risques cachés tu prends comme prochain propriétaire.",
    whyCards: [
      { title: "Protège ton argent", body: "Un titre marqué peut réduire la valeur de revente de 20 à 40 %. Le savoir avant de négocier t'évite de surpayer un historique endommagé." },
      { title: "Protège ta sécurité", body: "Des dommages structurels cachés ou d'inondation peuvent compromettre les airbags et les performances en choc. La marque est ton premier avertissement pour inspecter plus en profondeur." },
      { title: "Vérifie, ne fais pas confiance", body: "Les vendeurs peuvent ne pas divulguer une marque, et le lavage peut la cacher. L'historique VIN — pas le titre papier — est la seule preuve fiable." },
    ],
    h2Internal: "Plus de vérifications VIN qui se combinent avec une vérification salvage",
    internalIntro: "Les marques de titre sont une pièce du puzzle. Ces vérifications complètent le tableau avant d'acheter.",
    internalLinks: [
      { href: "/total-loss-check", label: "Vérification perte totale", desc: "Vois si un assureur a déjà déclaré le véhicule en perte totale — l'événement qui déclenche une marque salvage." },
      { href: "/flood-check", label: "Vérification dégâts d'inondation", desc: "L'inondation est l'une des raisons les plus dommageables — et les plus cachées — pour lesquelles une voiture finit marquée." },
      { href: "/accident-history-check", label: "Vérification historique d'accidents", desc: "Collisions rapportées et gravité des dommages qui peuvent avoir mené à une décision de perte totale." },
      { href: "/odometer-check", label: "Vérification odomètre", desc: "Les voitures marquées et reconstruites sont des cibles courantes de rollback — vérifie aussi le kilométrage." },
      { href: "/vin-check", label: "Vérification complète d'historique VIN", desc: "Marques de titre, accidents, odomètre, vol et registres de rappels dans un rapport complet." },
      { href: "/lemon-check", label: "Vérification citron", desc: "Approfondis les rachats constructeur et l'historique de défauts chroniques par VIN." },
    ],
    h2Faq: "Vérification titre salvage — Foire aux questions",
    faqIntro: "Les questions que les acheteurs posent le plus sur les titres salvage, reconstruits et marqués.",
    bottomBadge: "Gratuit · Instantané · Adossé NMVTIS",
    ctaBottomHeading: "Vérifie un titre salvage ou marqué maintenant",
    ctaBottomSub: "Saisis un VIN de 17 caractères pour vérifier instantanément NMVTIS et les registres DMV des 50 États pour les historiques salvage, reconstruit, inondation, ferraille et citron.",
