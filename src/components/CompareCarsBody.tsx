...
const COPY = {
  ...
  fr: {
    crumbs: { home: "Accueil", current: "Outil de comparaison de voitures" },
    h1: "Outil gratuit de comparaison de voitures",
    lede: "Compare n'importe quelles deux voitures côte à côte. Prix, MPG, chevaux, chargement, capacité de remorquage, sécurité, fiabilité, garantie et caractéristiques clés — pour plus de 40 modèles 2024 populaires. Choisis une marque et un modèle de chaque côté et l'outil met instantanément en évidence chaque catégorie gagnante.",
    whatH2: "Quoi comparer en premier",
    whatLede: "Les voitures sont des paquets de compromis. Ces cinq domaines déterminent 90 % de la satisfaction à long terme — bien les comparer fait la différence entre adorer la voiture que tu as achetée et la regretter dans deux ans.",
    whatItems: [
      { title: "Prix total", copy: "Le MSRP n'est qu'un début. Compare les prix de départ et les prix de la finition haut de gamme — les versions entièrement équipées peuvent différer de plus de 20 000 $. Ajoute les frais de destination, taxes et immatriculation pour obtenir le vrai chiffre." },
      { title: "Économie de carburant (MPG)", copy: "Le MPG combiné correspond le plus à ce que la plupart des conducteurs voient. Une différence de 5 MPG à 13 500 mi/an représente environ 300 $/an — sur une période de propriété de 7 ans, c'est plus de 2 000 $ d'économies." },
      { title: "Sécurité et fiabilité", copy: "Les étoiles de crash-test NHTSA (5 étant le meilleur) reflètent la sécurité physique. Les scores de fiabilité prédisent la fréquence des réparations et les visites non programmées à l'atelier. Les deux s'accumulent avec l'âge — achète fiable, surtout pour une détention à long terme." },
      { title: "Chargement et praticité", copy: "Les sièges, les pieds cubes de chargement et la capacité de remorquage importent plus que les chevaux pour la plupart des familles. Quelques pieds cubes supplémentaires de chargement peuvent faire la différence entre emmener la famille en road trip ou louer un véhicule plus grand." },
      { title: "Performance", copy: "Chevaux, couple, 0-60 et transmission. Pour les navetteurs, tout ce qui dépasse 180 ch est largement suffisant. Pour le remorquage ou la conduite sportive, regarde d'abord le couple et la transmission — ce sont eux qui font avancer le véhicule." },
    ],
    popularH2: "Comparaisons courantes",
    popularLede: "Les face-à-face les plus recherchés du marché. Clique sur n'importe quelle paire pour voir la comparaison complète côte à côte.",
    vs: "vs",
    popular: [
      { a: "toyota-camry", b: "honda-accord", aLabel: "Toyota Camry", bLabel: "Honda Accord", note: "Les deux berlines les plus vendues d'Amérique" },
      { a: "honda-civic", b: "toyota-corolla", aLabel: "Honda Civic", bLabel: "Toyota Corolla", note: "Compactes les plus vendues" },
      { a: "toyota-rav4", b: "honda-cr-v", aLabel: "Toyota RAV4", bLabel: "Honda CR-V", note: "Top des SUV compacts aux É.-U." },
      { a: "ford-f-150", b: "chevrolet-silverado-1500", aLabel: "Ford F-150", bLabel: "Chevy Silverado", note: "Rivaux des pickups pleine grandeur" },
      { a: "tesla-model-3", b: "tesla-model-y", aLabel: "Tesla Model 3", bLabel: "Tesla Model Y", note: "Tesla berline vs SUV" },
      { a: "toyota-tacoma", b: "ford-bronco", aLabel: "Toyota Tacoma", bLabel: "Ford Bronco", note: "Favoris du tout-terrain" },
      { a: "bmw-3-series", b: "audi-a4", aLabel: "BMW Série 3", bLabel: "Audi A4", note: "Berlines sportives allemandes" },
      { a: "subaru-outback", b: "subaru-forester", aLabel: "Subaru Outback", bLabel: "Subaru Forester", note: "Break vs SUV" },
    ],
    chooseH2: "Comment choisir entre deux voitures",
    chooseP1: "Commence par les éliminations immédiates. Si tu remorques un bateau de 6 000 lb chaque week-end, aucune économie de carburant ne fait d'une Camry la bonne réponse — élimine tout ce qui ne peut pas faire le travail avant de comparer les plus-à-avoir.",
    chooseP2: "Ensuite, pondère les catégories selon la fréquence à laquelle tu les utiliseras. Un 0-60 de 5 secondes est amusant lors de l'essai routier mais importe moins que les différences de coût de carburant sur 5 ans pour la plupart des acheteurs. L'espace de chargement gagne plus de discussions au trottoir de l'aéroport que les chevaux ne gagnent sur l'autoroute.",
    chooseP3: "Enfin, tiens compte du long terme. La fiabilité et la valeur de revente se cumulent — un véhicule qui coûte 2 000 $ de moins et se déprécie 10 % plus lentement peut surpasser un rival plus tape-à-l'œil de plus de 5 000 $ sur 7 ans. L'outil de comparaison ci-dessus montre tout cela dans une seule vue pour que tu ne manques pas la perspective à long terme tout en admirant le chiffre de chevaux.",
    faqH2: "Questions fréquentes",
    crossLinks: [
      { href: "/car-loan-calculator", label: "Calculateur de prêt auto", sub: "Paiement mensuel et amortissement" },
      { href: "/total-cost-of-ownership-calculator", label: "Coût total de propriété", sub: "Mathématiques de propriété sur 5 ans" },
      { href: "/gas-mileage-calculator", label: "Calculateur de consommation", sub: "Coût de carburant par mile/mois/an" },
    ],
    cta: { h2: "Trouvé ton match ? Vérifie d'abord le VIN.", body: "Choisir le bon modèle est la moitié du travail. Avant d'acheter, lance une vérification VIN gratuite sur le véhicule spécifique pour t'assurer que son historique est propre — pas de titre salvage, pas de manipulation d'odomètre, pas de rappels ouverts.", button: "Lance une vérification VIN gratuite" },
  },
} as const;
