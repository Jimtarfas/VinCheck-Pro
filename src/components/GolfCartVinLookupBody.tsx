...
const COPY = {
  ...
  fr: {
    home: "Accueil", crumb: "Recherche VIN de voiturette de golf",
    badge: "Voiturette de golf = numéro de série   ·   Pas un VIN routier",
    h1Lead: "Recherche VIN de voiturette de golf — ",
    h1Accent: "Décode la série et l'année",
    intro1: "Les voiturettes de golf ne portent pas un VIN routier de 17 caractères — elles utilisent un ",
    introBold: "numéro de série du fabricant",
    intro2: " qui encode l'année modèle. Trouve-le, décode-le et sache exactement de quelle année est ta voiturette Club Car, E-Z-GO ou Yamaha.",
    trustStats: [
      { icon: Car, value: "3 marques", label: "Club Car · EZGO · Yamaha" },
      { icon: Calendar, value: "Année modèle", label: "depuis la série" },
      { icon: Zap, value: "Instantané", label: "sans inscription" },
      { icon: BadgeCheck, value: "Gratuit", label: "décodage de série" },
    ],
    h2Vin: "Le « VIN » d'une voiturette de golf est son numéro de série",
    vinIntroPre: "Voici la réponse honnête que la plupart cherchent : une voiturette de golf ",
    vinIntroBold1: "n'a pas de VIN de 17 caractères",
    vinIntroMid: " comme une voiture. En tant que véhicule basse vitesse hors route, elle est identifiée par un ",
    vinIntroBold2: "numéro de série du fabricant",
    vinIntroSuffix: " à la place — et cette série est exactement ce que tu lis pour trouver l'année, commander des pièces ou confirmer une voiturette avant d'acheter.",
    cartTag: "Voiturette de golf",
    cartTitle: "Numéro de série",
    cartBullets: [
      "Attribué par le fabricant — Club Car, E-Z-GO, Yamaha.",
      "Encode l'année modèle et la série de production.",
      "Sur le châssis et une étiquette sous le siège ou la boîte à gants.",
    ],
    carTag: "Voiture / Camion",
    carTitle: "VIN de 17 caractères",
    carBulletsPre: ["Requis sur les véhicules routiers construits depuis 1981.", "Décode marque, modèle, année, moteur et usine."],
    carBullet3Pre: "Une conversion LSV de rue peut obtenir un vrai VIN — ",
    carBullet3Link: "décode-le ici",
    carBullet3Suffix: ".",
    bottomLineBold: "Conclusion :",
    bottomLineMid: " si tu as cherché « VIN de voiturette de golf », ce dont tu as réellement besoin est le ",
    bottomLineBold2: "numéro de série",
    bottomLineSuffix: ". Trouve-le, et les guides de marque ci-dessous (plus le décodeur Club Car en haut) le convertissent en une année modèle.",
    h2How: "Comment chercher l'année d'une voiturette de golf — Étape par étape",
    howIntro: "Cinq étapes de « c'est quelle année ? » à l'année modèle exacte — pour Club Car, E-Z-GO et Yamaha.",
    stepWord: "Étape",
    howSteps: [
      { step: "01", title: "Identifie la marque", body: "Club Car, E-Z-GO et Yamaha encodent chacun l'année de construction différemment, donc la marque décide comment tu lis la série. C'est habituellement badgé sur la carrosserie, la colonne de direction ou le dossier du siège." },
      { step: "02", title: "Trouve le numéro de série", body: "Cherche sous la boîte à gants ou le siège du conducteur (Club Car), sous le siège ou près du contrôleur (E-Z-GO), ou estampé sur le châssis sous le siège (Yamaha). Vérifie toujours le marquage du châssis, pas seulement un autocollant." },
      { step: "03", title: "Lis ou décode l'année", body: "Pour une Club Car, mets la série dans le décodeur ci-dessus pour obtenir l'année modèle et la semaine de production instantanément. Pour Yamaha et E-Z-GO, fais correspondre le préfixe de modèle au tableau d'années de cette marque ci-dessous." },
      { step: "04", title: "Vérifie contre la voiturette", body: "Confirme que l'année et le modèle décodés correspondent aux caractéristiques de la voiturette et à l'affirmation du vendeur. Une série qui décode à une année différente de celle annoncée est une raison de poser des questions avant d'acheter." },
      { step: "05", title: "Utilise-le pour commander des pièces ou la prix", body: "Les batteries, contrôleurs et accessoires de voiturettes de golf sont spécifiques à l'année et au modèle. L'année modèle exacte est ce dont tu as besoin pour commander les bonnes pièces ou évaluer la voiturette équitablement." },
    ],
    h2Brand: "Numéros de série par marque — Club Car, E-Z-GO et Yamaha",
    brandIntro: "Chaque fabricant cache l'année dans un endroit et un format différent. Voici où chercher et comment l'année est encodée pour les trois grandes marques.",
    brandColBrand: "Marque", brandColWhere: "Où trouver la série",
    brandColFormat: "Comment l'année est encodée", brandColDecodes: "Décode ici ?",
    brandRows: [
      { brand: "Club Car", where: "Étiquette code-barres sous la boîte à gants ou le siège côté conducteur ; estampé sur le châssis.", format: "2 lettres (préfixe de modèle) + AA (année) + SS (semaine) + séquence. PG05 = année modèle 2005. Décode-le instantanément ci-dessus.", decodes: "Oui — déterministe" },
      { brand: "E-Z-GO", where: "Sous le siège ou sur le châssis près du contrôleur ; numéro du fabricant sur la carrosserie.", format: "Code du fabricant + série. Les modèles plus récents intègrent l'année dans le numéro du fabricant ; les voiturettes plus anciennes utilisent un code de date/construction — fais correspondre à un tableau d'ère E-Z-GO.", decodes: "Via tableau de marque" },
      { brand: "Yamaha", where: "Estampé sur le châssis sous le siège ; autocollant sous la carrosserie.", format: "Code de modèle + série. L'année vit dans le préfixe de modèle (ex. série G, Drive, Drive2), lu depuis le tableau année/modèle de Yamaha — pas un chiffre fixe.", decodes: "Via tableau de marque" },
    ],
    brandFooterPre: "Le décodeur en haut de cette page lit directement le format ",
    brandFooterBold: "Club Car",
    brandFooterSuffix: ". Pour Yamaha et E-Z-GO, trouve la série en utilisant le guide ci-dessus, puis fais correspondre le préfixe de modèle au tableau officiel d'années de cette marque — nous ne devinons pas une année que nous ne pouvons pas vérifier à partir de la série seule.",
    h2Breakdown: "Comment se décompose un numéro de série Club Car",
    breakdownIntroPre: "La série de Club Car est la plus facile à décoder car l'année et la semaine sont à des positions fixes. Prends un exemple comme ",
    breakdownExample: "PG0512345678",
    breakdownIntroSuffix: " :",
    breakdownColPos: "Position", breakdownColEx: "Exemple", breakdownColMean: "Signification",
    breakdownRows: [
      { pos: "1–2", ex: "PG", mean: "Préfixe de modèle / assemblage (la ligne de voiturette)" },
      { pos: "3–4", ex: "05", mean: "Année modèle — ici, 2005" },
      { pos: "5–6", ex: "12", mean: "Semaine de production — ici, semaine 12" },
      { pos: "7+", ex: "345678", mean: "Numéro de séquence de production" },
    ],
    breakdownNote: "Note : les unités Club Car DS très anciennes (années 80) et certaines séries spéciales varient légèrement. Les chiffres de l'année (positions 3-4) sont le chiffre fiable — le décodeur marque tout ce qui ne correspond pas au schéma standard de semaine.",
    midCtaHeading: "Tu achètes une voiturette de rue avec un vrai VIN ?",
    midCtaSub: "Certains véhicules basse vitesse sont immatriculés avec un vrai VIN de 17 caractères. Si le tien en a un, décode-le gratuitement pour la marque, le modèle, l'année et l'historique complet.",
    midCtaBtn: "Décode un VIN de 17 caractères",
    h2Buy: "Vérifie la série avant d'acheter une voiturette d'occasion",
    buy1: "Le numéro de série est l'identité d'une voiturette de golf, donc c'est la première chose à vérifier sur un achat d'occasion. Décode l'année et confirme qu'elle correspond à ce que le vendeur a annoncé — les années modèles sur les voiturettes sont faciles à falsifier car il n'y a pas de titre ni de VIN routier pour maintenir tout le monde honnête.",
    buy2: "Fais correspondre la série sur le châssis à toute étiquette et à l'acte de vente. Puis utilise l'année modèle exacte pour donner un prix à la voiturette et commander les bonnes batteries, contrôleur et pièces — les composants de voiturettes de golf sont strictement spécifiques à l'année et au modèle.",
    buy3: "Pour les détails de construction ou pour confirmer qu'une voiturette n'est pas signalée comme volée, contacte directement le fabricant avec la série du châssis — les voiturettes de golf ne sont pas dans les bases de données de vol de véhicules routiers comme le sont les voitures.",
    redFlagsTitle: "Drapeaux rouges de la série de voiturette de golf",
    redFlags: [
      "L'année décodée ne correspond pas à l'année annoncée",
      "La série sur le châssis diffère de l'étiquette ou de l'acte de vente",
      "La zone du châssis semble meulée ou repeinte sur le marquage",
      "Le vendeur ne peut pas ou ne veut pas te montrer le numéro de série",
      "Pas d'acte de vente sur un achat d'occasion entre particuliers",
    ],
    h2Internal: "Plus de recherches de véhicules",
    internalIntro: "Tu décodes quelque chose avec un VIN routier ? Ces outils te couvrent.",
    internalLinks: [
      { href: "/", label: "Décodeur VIN de voiture et camion", desc: "Pour un LSV de rue avec un vrai VIN de 17 caractères, décode-le ici pour marque, modèle et année." },
      { href: "/motorcycle-vin-search", label: "Recherche VIN de moto", desc: "Décode le numéro de châssis d'une moto ou VTT pour marque, modèle et moteur." },
      { href: "/hin-lookup", label: "Recherche HIN (VIN de bateau)", desc: "L'équivalent de la série d'un bateau — décode un Numéro d'Identification de Coque de 12 caractères." },
      { href: "/rv-vin-check", label: "Vérification VIN de VR", desc: "Décode et vérifie l'historique du VIN d'une autocaravane ou roulotte de voyage." },
      { href: "/stolen-vehicle-check", label: "Vérification de véhicule volé", desc: "Pour les véhicules routiers avec un VIN — confirme qu'il n'est pas signalé comme volé avant d'acheter." },
      { href: "/chassis-number-lookup", label: "Recherche de numéro de châssis", desc: "Le même VIN de 17 caractères s'appelle numéro de châssis hors Amérique du Nord." },
    ],
    h2Faq: "Recherche VIN / série de voiturette de golf — Foire aux questions",
    faqIntro: "Réponses directes à ce que les propriétaires et acheteurs de voiturettes de golf demandent le plus.",
    bottomBadge: "Gratuit · Instantané · Décodeur Club Car",
    ctaBottomHeading: "Trouve l'année de ta voiturette de golf depuis la série",
    ctaBottomSub: "Fais défiler vers le haut pour décoder une série Club Car instantanément, ou utilise les guides de marque pour lire une année Yamaha ou E-Z-GO. Gratuit, sans inscription.",
    ctaBottomNote: "Pas de carte de crédit · Pas d'inscription · Guide honnête et précis par marque",
  },
} as const;
