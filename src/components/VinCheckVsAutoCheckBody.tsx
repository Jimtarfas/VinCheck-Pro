...
const ROWS_FR: typeof ROWS_EN = [
  { feature: "Prix du rapport unique", us: SINGLE, them: AC_SINGLE },
  { feature: "Lots de rapports", us: `${B3} (3) · ${B10} (10)`, them: "$49.99 (25 rapports)" },
  ...
  { feature: "Vraies photos du véhicule", us: true, them: false },
  { feature: "Estimation de valeur de marché", us: true, them: false },
  { feature: "Score de risque propriétaire (0-100)", us: false, them: true },
  { feature: "Données piste enchères (axé concessionnaires)", us: false, them: true },
...
const COPY = {
  ...
  fr: {
    home: "Accueil", crumb: "CarCheckerVIN vs AutoCheck",
    badge: `Alternative à AutoCheck   ·   Comparatif 2026`,
    h1Lead: "CarCheckerVIN vs AutoCheck — ",
    h1Accent: `Mêmes données, ${SINGLE} au lieu de ${AC_SINGLE}`,
    intro: `AutoCheck, propriété d'Experian, est la deuxième marque d'historique de véhicule la plus reconnue aux États-Unis après Carfax, surtout connue pour le Score AutoCheck de 0-100. CarCheckerVIN adopte une approche différente : ${SINGLE} par rapport, vraies photos du véhicule, estimation de valeur de marché et décodage instantané gratuit que tu peux lancer sans compte. Voici un comparatif honnête, vérifié, côte à côte.`,
    formHeading: "Lance une vérification VIN maintenant",
    formSub: `Décodage instantané gratuit, ou rapport d'historique complet pour ${SINGLE}`,
    trustStats: [
      { icon: DollarSign, value: SINGLE, label: "par rapport unique" },
      { icon: ShieldCheck, value: "NMVTIS", label: "source fédérale" },
      { icon: Camera, value: "Photos", label: "vraies photos du véhicule" },
      { icon: Clock, value: "< 5 sec", label: "temps de recherche moyen" },
      { icon: BadgeCheck, value: "Gratuit", label: "décodage VIN, sans inscription" },
    ],
    headlineStatsHeading: "CarCheckerVIN vs AutoCheck — En chiffres",
    headlineStats: [
      { value: SINGLE, label: `Rapport unique CarCheckerVIN (vs ${AC_SINGLE})` },
      { value: "Gratuit", label: "Décodage VIN instantané, sans compte" },
      { value: "Les 50", label: "DMV étatiques plus couverture NMVTIS" },
      { value: "0-100", label: "Score AutoCheck que tu peux ignorer" },
    ],
    h2Compare: "Comparatif côte à côte",
    compareIntro: "Une décomposition caractéristique par caractéristique basée sur les prix au détail publiquement listés et le contenu des rapports des deux services. Le prix d'AutoCheck est tiré du site grand public autocheck.com.",
    thFeature: "Caractéristique", thUs: "CarCheckerVIN", thThem: "AutoCheck",
    rows: ROWS_FR,
    pricingNote: "Les prix reflètent le prix de détail publiquement listé pour les rapports individuels grand public. Les prix pour concessionnaires diffèrent. Les crédits de lots sont valables 12 mois.",
    h2Pricing: "Prix — Ce que chacun coûte vraiment",
    usCardHeading: "CarCheckerVIN",
    themCardHeading: "AutoCheck",
    rowSingle: "Rapport unique", rowB3: "Lot de 3 rapports", rowB5: "Lot de 5 rapports", rowB10: "Lot de 10 rapports", rowFreeDecode: "Décodage VIN gratuit", rowIncluded: "Inclus", rowNotOffered: "Non offert",
    rowAcBundle: "Pack 25 rapports (21 jours)",
    price1: `Cela place un rapport unique CarCheckerVIN à ${SINGLE}, bien sous la moitié des ${AC_SINGLE} d'AutoCheck. Pour un acheteur comparant trois ou quatre voitures, le lot de 3 rapports à ${B3} de CarCheckerVIN couvre le travail pour moins que le prix de deux rapports AutoCheck, et les rapports non utilisés restent sur ton compte comme crédits pendant une année complète.`,
    price2: `Le pack de 25 rapports d'AutoCheck est vraiment utile si tu es un concessionnaire indépendant avec un gros volume d'enchères. Pour un consommateur typique achetant une ou deux voitures par an, tu approcheras rarement l'utilisation des 25 dans la fenêtre de 21 jours, ce qui rend le coût par rapport réellement utilisé bien plus élevé que ce que suggère le tarif vedette de $49.99.`,
    h2Score: "Le Score AutoCheck — Utile ou marketing ?",
    score1: "La caractéristique la plus distinctive d'AutoCheck est le Score AutoCheck, un nombre de 0-100 qui regroupe l'âge, le kilométrage, les marques de titre et les événements rapportés d'un véhicule en une seule métrique synthétique, puis le compare à un groupe similaire de véhicules. Le score est vraiment populaire dans les enchères de gros, où les acheteurs ont besoin d'un classement relatif rapide parmi des centaines de véhicules en une seule matinée.",
    score2Pre: "Pour un acheteur privé, cependant, un score de risque unique ne remplace pas la lecture réelle des données sous-jacentes. Un véhicule avec un titre propre, sans accidents rapportés et une chronologie d'odomètre cohérente est un bon pari que le score soit 88 ou 92. CarCheckerVIN te donne les mêmes ",
    stolenLink: "registres NMVTIS, NICB et DMV",
    score2Suffix: " et te laisse faire l'appel toi-même, plus des vraies photos du véhicule qu'AutoCheck n'inclut pas.",
    h2Data: "Sources de données — D'où viennent les rapports",
    d1: "Les deux services puisent dans la même colonne vertébrale de données publiques et industrielles : le National Motor Vehicle Title Information System (NMVTIS), les 50 DMV étatiques, le National Insurance Crime Bureau (NICB) pour les registres de véhicules volés, la National Highway Traffic Safety Administration (NHTSA) pour les rappels, et divers flux de l'industrie de l'assurance pour les accidents et événements de perte totale.",
    d2: "La position d'Experian comme société de crédit et de données donne à AutoCheck un fort accès aux données des pistes d'enchères, c'est pourquoi les concessionnaires de gros aiment la plateforme. CarCheckerVIN s'appuie sur les mêmes flux NMVTIS, NICB, NHTSA et DMV étatiques, plus des échanges de données partenaires pour les événements d'accidents et d'épave, couvrant les mêmes points de données critiques qui déterminent si une voiture est sûre à acheter.",
    d3: "Pour 95% des acheteurs de voitures d'occasion, les données qui comptent le plus (marques de titre, accidents, vol, recul d'odomètre, rappels) sont essentiellement identiques entre les deux fournisseurs. Les différences sont la présentation, les photos et le prix.",
    h2Includes: "Ce que chaque rapport inclut vraiment",
    incPre: "Un rapport premium CarCheckerVIN inclut un décodage VIN complet et les données de construction d'usine, l'historique des marques de titre NMVTIS incluant les ",
    salvageLink: "marques d'épave et reconstruit",
    incMid1: ", l'",
    accidentLink: "historique d'accidents",
    incMid2: " rapporté, la ",
    odoLink: "chronologie odomètre et kilométrage",
    incMid3: ", la vérification véhicule volé NICB, les rappels ouverts, les ",
    lemonLink: "indicateurs rachat constructeur / lemon",
    incSuffix: ", une estimation de valeur de marché et de vraies photos du véhicule lorsqu'elles sont disponibles.",
    inc2: "Un rapport AutoCheck inclut la plupart des mêmes ensembles de données majeurs plus le Score AutoCheck propriétaire et un solide historique de piste d'enchères. Les rapports AutoCheck n'incluent généralement pas de vraies photos du véhicule ni d'estimation de valeur de marché au niveau grand public.",
    h2AcWhen: "Quand AutoCheck a du sens",
    acBullets: [
      "Tu es un acheteur de gros ou d'enchères qui utilise vraiment le Score AutoCheck pour classer des dizaines de véhicules par session.",
      "Tu lances un gros volume de rapports chaque mois et peux utiliser le lot de 25 rapports efficacement dans sa fenêtre de 21 jours.",
      "Le véhicule est vendu via une enchère qui annonce spécifiquement un historique soutenu par AutoCheck.",
    ],
    h2UsWhen: "Quand choisir CarCheckerVIN",
    usBullets: [
      `Tu es un acheteur privé comparant un à cinq véhicules et veux maintenir bas le total des dépenses en rapports (à partir de ${SINGLE} par rapport).`,
      "Tu veux des vraies photos du véhicule et une estimation de valeur de marché à côté des données de titre et d'accidents.",
      "Tu veux un décodage VIN instantané gratuit sans créer de compte.",
      "Tu préfères lire toi-même les événements bruts plutôt que de te fier à un seul score de risque propriétaire.",
    ],
    h2Bottom: "La conclusion",
    bottom1: `AutoCheck est un produit crédible soutenu par Experian dont le plus grand avantage est le Score AutoCheck et sa solide position dans la piste d'enchères de gros. Pour un acheteur privé évaluant une poignée de voitures d'occasion, tu peux obtenir les mêmes données NMVTIS, NICB, DMV et NHTSA, plus de vraies photos et une valeur de marché, pour ${SINGLE} avec CarCheckerVIN, bien sous la moitié des ${AC_SINGLE} d'AutoCheck.`,
    bottom2Pre: "Vois comment cela se compare aux autres fournisseurs majeurs dans notre ",
    carfaxLink: "comparatif CarCheckerVIN vs Carfax",
    bottom2Mid: ", ou lance un décodage gratuit maintenant depuis notre ",
    vinLink: "page de vérification VIN",
    bottom2Suffix: ".",
    midCtaHeading: `Vois à quoi ressemble un rapport à ${SINGLE}`,
    midCtaSub: `Entre un VIN de 17 caractères pour un décodage instantané gratuit, puis débloque l'historique complet pour ${SINGLE}. Sans abonnement, sans paywall Score AutoCheck.`,
    h2Faq: "Questions fréquentes",
    faqSub: "Les questions que les acheteurs de voitures d'occasion posent le plus souvent en comparant CarCheckerVIN et Experian AutoCheck.",
    bottomBadge: `Décodage gratuit · rapport complet ${SINGLE}`,
    ctaBottomHeading: "Une alternative à AutoCheck plus intelligente et moins chère",
    ctaBottomSub: `Les mêmes données NMVTIS, NICB, DMV et NHTSA qu'AutoCheck utilise, plus de vraies photos et une valeur de marché, pour ${SINGLE} au lieu de ${AC_SINGLE}.`,
