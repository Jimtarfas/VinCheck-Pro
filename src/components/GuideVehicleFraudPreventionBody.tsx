...
const COPY = {
  ...
  fr: {
    crumbs: { home: "Accueil", guides: "Guides", current: "Prévention de la fraude au véhicule" },
    h1: "Prévention de la fraude au véhicule : Le guide définitif",
    intro: "La Federal Trade Commission et le National Insurance Crime Bureau placent les pertes annuelles combinées dues à la fraude liée aux voitures bien à l'intérieur des milliards. Du lavage de titre au clonage de VIN, les arnaques deviennent plus sophistiquées, et les marketplaces en ligne ont transformé ce qui était autrefois des arnaques locales en opérations nationales. Ce guide décortique chaque catégorie majeure de fraude, comment la détecter et le manuel défensif qui l'attrape avant que l'argent ne change de mains.",
    verifyBoxTitle: "Vérifie un VIN maintenant",
    verifyBoxSub: "L'outil antifraude le plus puissant : décode le VIN contre les données de titre NMVTIS et les dossiers de vol NICB en quelques secondes.",
    tocTitle: "Dans ce guide",
    tocItems: [
      { href: "#scope", label: "L'ampleur de la fraude au véhicule en 2026" },
      { href: "#title-fraud", label: "Fraude de titre et lavage de titre" },
      { href: "#odometer", label: "Recul d'odomètre" },
      { href: "#salvage", label: "Lavage de salvage et fraude de rebuilt" },
      { href: "#vin-cloning", label: "Clonage de VIN et véhicules volés" },
      { href: "#dealer-scams", label: "Arnaques côté concessionnaire" },
      { href: "#online-scams", label: "Arnaques en ligne et entre particuliers" },
      { href: "#nicb", label: "Utiliser NICB et NMVTIS pour vérifier" },
      { href: "#protocol", label: "Ton protocole de protection acheteur en six étapes" },
      { href: "#after-fraud", label: "Que faire si tu t'es fait arnaquer" },
    ],
    s1Heading: "L'ampleur de la fraude au véhicule en 2026",
    s1p1: "Les rapports annuels du National Insurance Crime Bureau placent les vols de véhicules au-dessus d'un million par an pour la troisième année consécutive, avec les pertes les plus élevées concentrées dans les zones métropolitaines du Texas, de Californie et de Floride. Par-dessus le vol s'empilent les fraudes secondaires : lavage de titre, réémission de salvage et manipulation d'odomètre. Le Department of Transportation estime depuis longtemps que plus de 450 000 véhicules par an sont vendus avec des odomètres reculés, coûtant aux acheteurs américains plus d'un milliard de dollars par an.",
    s1p2: "Les marketplaces en ligne ont élargi le terrain de jeu. L'Internet Crime Complaint Center (IC3) du FBI a constamment signalé les arnaques liées aux voitures comme l'une des plus grandes catégories par pertes signalées, alimentées par les arnaques de non-livraison, les faux sites d'escrow et les services d'expédition contrefaits. Le fil commun : chaque arnaque ci-dessous soit manipule l'identité du véhicule (le VIN et le titre), soit abuse du mode de paiement de l'acheteur. Se défendre contre la fraude signifie défendre les deux extrémités de cette chaîne.",
    s2Heading: "Fraude de titre et lavage de titre",
    s2p1Pre: "La fraude de titre est toute arnaque qui falsifie, altère ou blanchit le titre légal d'un véhicule. La variante la plus courante est le ",
    s2p1Bold: "lavage de titre",
    s2p1Mid: " : un véhicule marqué comme salvage, rebuilt, inondation ou junk dans un état est re-titré dans un autre état avec des règles de marquage plus laxistes, et la marque \u201Cse lave\u201D du nouveau titre. NMVTIS \u2014 le National Motor Vehicle Title Information System administré par le Department of Justice \u2014 a été créé spécifiquement pour combattre cela, mais seuls les fournisseurs de données approuvés NMVTIS l'interrogent de manière cohérente.",
    s2p2Pre: "La mécanique fonctionne typiquement comme ceci : un véhicule perte totale par inondation en Louisiane est vendu en enchère de salvage, transporté dans un état avec des règles plus faibles de portabilité de marque, réparé cosmétiquement, re-titré propre, puis revendu au prix du marché complet à un acheteur sans méfiance à des milliers de miles de distance. Les acheteurs apprennent la vérité des mois plus tard quand la corrosion détruit les systèmes électriques ou que l'assurance refuse une réclamation. Une ",
    s2p2Link: "vérification de salvage title",
    s2p2Suffix: " soutenue par NMVTIS fait apparaître la marque d'origine même quand le titre actuel ne l'affiche pas.",
    s2p3: "Vérifications défensives : confirme que le titre est émis dans l'état de résidence du vendeur, vérifie que les filigranes et les sceaux en relief correspondent au modèle actuel du DMV émetteur, cherche toute rature ou liquide correcteur et croise chaque état de titre antérieur listé dans le rapport d'historique. Chaque fois que la chaîne rebondit entre trois états ou plus en moins de cinq ans, traite-le comme un drapeau jaune et creuse davantage.",
    s3Heading: "Recul d'odomètre",
    s3p1: "Les odomètres numériques modernes étaient censés rendre le recul obsolète. Ils ne l'ont pas fait. Une analyse financée par la NHTSA en 2022 a montré que la fraude d'odomètre augmente à mesure que les véhicules hors leasing avec des valeurs résiduelles plus élevées entrent sur le marché de la revente, et les 450 000 véhicules par an affectés estimés coûtent aux consommateurs une moyenne de $4 000 par transaction. Le recul est maintenant exécuté via des outils OBD-II vendus ouvertement en ligne, parfois étiquetés comme dispositifs de \u201Ccorrection de kilométrage\u201D.",
    s3p2: "Trois signaux exposent le recul même avant que tu n'extraies un rapport. D'abord, l'incohérence d'usure : plaquettes de pédale de frein brillantes, prise du volant polie lisse ou affaissement du renfort latéral du siège conducteur sur un véhicule affichant 35 000 miles ne s'additionnent pas. Deuxièmement, dossiers de service : factures de service du concessionnaire, autocollants de vidange d'huile et autocollants d'inspection portent tous des cachets de kilométrage qui peuvent être croisés. Troisièmement, rapports d'historique : chaque transfert de titre NMVTIS capture une lecture d'odomètre ; si la chaîne montre 92 000 miles en 2023 et 41 000 miles aujourd'hui, il a été reculé.",
    s3p3Pre: "Notre outil de ",
    s3p3Link: "vérification d'odomètre",
    s3p3Suffix: " fait passer tout l'historique de lectures NMVTIS à travers une vérification de monotonie et signale toute discontinuité, y compris le motif subtil de \u201Cplateau\u201D où l'odomètre bouge à peine entre deux événements rapportés.",
    s4Heading: "Lavage de salvage et fraude de rebuilt",
    s4p1: "Le lavage de salvage chevauche le lavage de titre mais mérite sa propre section parce que l'impact financier est si sévère. Un véhicule au titre de salvage est un véhicule qu'un assureur a déclaré perte totale, généralement parce que les coûts de réparation ont dépassé 70 à 90 % de la valeur marchande avant sinistre. Les titres rebuilt sont émis après qu'un véhicule de salvage est réparé et ré-inspecté, mais la rigueur de l'inspection varie énormément entre les états \u2014 certains exigent un examen structurel multi-points, d'autres une inspection visuelle générale.",
    s4p2: "Les véhicules inondés sont la catégorie la plus dangereuse. Après les grands événements d'ouragan, la NICB a suivi des dizaines de milliers de véhicules endommagés par les inondations qui ré-entrent sur le marché. Les dégâts sont électriques et métallurgiques \u2014 la corrosion se propage lentement, les modules d'airbag et d'ABS tombent en panne de manière imprévisible, et le véhicule peut passer un essai routier décontracté tout en abritant des défaillances qui apparaissent six à vingt-quatre mois plus tard. Lance une vérification d'historique complète sur tout véhicule titré ou enregistré dans un état côtier inondable pendant les mois suivant une tempête nommée.",
    s4p3Pre: "Indices d'inspection visuelle : limon ou boue séchée dans les rails de siège, les puits de roue de secours, les clips de faisceau de câbles et sous les bords de tapis. Odeur intérieure de moisi qui revient après ventilation. Tapis remplacé seulement dans les espaces pieds avant. Rouille importante sur les composants de suspension ou la quincaillerie qui devrait encore avoir l'air d'usine. Combine l'inspection avec notre ",
    s4p3Link: "vérification d'historique d'accidents et de dégâts",
    s4p3Suffix: " pour une image complète.",
    s5Heading: "Clonage de VIN et véhicules volés",
    s5p1: "Le clonage de VIN est l'acte de voler un véhicule et de remplacer son identité par le VIN d'un véhicule identique en marque et modèle qui est légalement titré ailleurs. Les acheteurs qui virent le paiement reçoivent un véhicule avec une paperasse qui a l'air légitime \u2014 jusqu'à ce que les forces de l'ordre retracent le VIN d'origine et récupèrent la voiture. L'acheteur perd à la fois le véhicule et l'argent.",
    s5p2: "Vérifications défensives pour le clonage : vérifie physiquement le VIN à trois endroits \u2014 la plaque du tableau de bord visible à travers le pare-brise, l'autocollant du chambranle de porte côté conducteur et l'estampage du compartiment moteur ou du pare-feu. Tous doivent correspondre entre eux et au titre. Cherche les manipulations sur la plaque du tableau de bord (rivets qui ont l'air neufs, plaque qui dépasse de la surface, résidus de colle autour des bords) \u2014 les plaques VIN légitimes du tableau de bord sont installées par le fabricant avec des rivets de sécurité difficiles à retirer proprement.",
    s5p3Pre: "Lance ensuite une ",
    s5p3Link: "vérification de véhicule volé",
    s5p3Suffix: " contre la base de données VINCheck de la NICB, qui agrège les rapports de vol des assureurs membres. Un résultat NICB propre ne garantit pas que le véhicule n'est pas cloné, mais un hit est concluant. La vérification combinée \u2014 triangulation physique du VIN plus NICB plus NMVTIS \u2014 attrape la grande majorité des tentatives de clonage.",
    s6Heading: "Arnaques côté concessionnaire",
    s6Intro: "Toutes les fraudes ne viennent pas de particuliers. Les arnaques côté concessionnaire sont généralement plus subtiles et habillées d'une paperasse à l'apparence légitime. Les variantes courantes incluent :",
    s6Bullets: [
      { bold: "Financement yo-yo", body: " \u2014 l'acheteur ramène la voiture à la maison, puis on lui dit des jours plus tard que le financement \u201Cest tombé\u201D et il re-signe à un APR plus élevé. Les lois des états varient ; documente tout par écrit." },
      { bold: "Empaquetage d'add-ons", body: " \u2014 gravure, protecteur de tissu, azote ou protection de surface inclus dans le financement sans divulgation explicite." },
      { bold: "Publicité d'appât et changement", body: " \u2014 le véhicule annoncé est \u201Cjuste vendu\u201D à l'arrivée, mais une unité à prix plus élevé est commodément disponible." },
      { bold: "Curbstoning", body: " \u2014 un individu sans licence se faisant passer pour un vendeur particulier qui est en réalité un concessionnaire revendant un inventaire titré mais non enregistré pour éviter les obligations de lemon law et les protections du consommateur." },
      { bold: "Omission de titre marqué", body: " \u2014 le titre physique montre une marque, mais l'annonce du concessionnaire ne la divulgue pas." },
    ],
    s6OutroPre: "La posture défensive est la même pour chaque variante : insiste pour avoir le prix tout compris par écrit avant de signer, vérifie indépendamment la marque du titre contre ton propre rapport d'historique, et n'accepte pas d'assurances verbales sur ce qui devrait être documenté. Les acheteurs comparant la transparence entre concessionnaires franchisés et indépendants peuvent vouloir lire notre page ",
    s6OutroLink: "confiance et standards éditoriaux",
    s6OutroSuffix: " sur comment nous vérifions nos propres sources de données.",
    s7Heading: "Arnaques en ligne et entre particuliers",
    s7Intro: "La fraude au véhicule en ligne a une forme reconnaissable : le prix est significativement en dessous du marché, le vendeur est indisponible pour une visite en personne (souvent en invoquant un déploiement, une maladie ou un déménagement), et il propose un escrow tiers, un service d'expédition ou un mode de paiement qui met les fonds hors de ta portée. Drapeaux rouges courants :",
    s7Bullets: [
      "Les photos de l'annonce sont de stock ou volées d'une autre annonce (recherche d'image inversée pour vérifier).",
      "Le vendeur refuse une visite vidéo ou une vérification VIN en direct.",
      "Paiement demandé par virement à une adresse hors de l'état, cartes-cadeaux, cryptomonnaie ou services d'escrow inconnus.",
      "\u201CExpédition gratuite\u201D offerte par le vendeur en utilisant un service dont tu n'as pas entendu parler.",
      "Contrat ou facture portant le logo d'une vraie entreprise (eBay Motors, Carmax, etc.) mais pas du vrai domaine de l'entreprise.",
    ],
    s7Outro: "Règle défensive : si tu ne peux pas inspecter physiquement le véhicule et vérifier le VIN en personne, n'envoie pas d'argent. Pour les achats à longue distance, utilise uniquement des services qui retiennent les fonds contre le transfert de titre (par exemple, Carvana, courtiers établis entre concessionnaires) et jamais un service que le vendeur a recommandé que tu ne peux pas vérifier indépendamment.",
    s8Heading: "Utiliser NICB et NMVTIS pour vérifier",
    s8p1Pre: "Deux bases de données forment l'épine dorsale de la vérification de fraude côté consommateur. ",
    s8p1B1: "NMVTIS",
    s8p1Mid1: " (Department of Justice) consolide les données de titre et de marque des DMV d'état participants et est la source faisant autorité pour les vérifications d'historique de titre. ",
    s8p1B2: "NICB VINCheck",
    s8p1Suffix: " agrège les données de vol et de perte d'assurance des assureurs membres et est la source faisant autorité pour la vérification de véhicules volés. Les deux sont des intrants fondamentaux pour tout rapport d'historique de véhicule crédible.",
    s8p2: "Des outils gratuits de recherche publique existent pour les deux, mais ils ont des limites : l'outil consommateur de la NICB plafonne les requêtes par jour, et les données NMVTIS ne sont disponibles que via des fournisseurs de données approuvés. Les rapports de CarCheckerVIN extraient de fournisseurs approuvés NMVTIS et exécutent des requêtes NICB dans le cadre du flux standard de rapport, avec les résultats affichés dans la section pertinente du rapport orienté consommateur.",
    s9Heading: "Ton protocole de protection acheteur en six étapes",
    s9Intro: "Lance cette liste de six étapes sur chaque transaction de véhicule d'occasion, sans exception :",
    s9Steps: [
      { bold: "Vérifie que le VIN", body: " correspond entre la plaque du tableau de bord, l'autocollant du chambranle de porte, l'estampage du compartiment moteur, le titre, l'enregistrement et la facture de vente." },
      { bold: "Extrais l'historique complet du véhicule", body: " d'un fournisseur approuvé NMVTIS et lis chaque section." },
      { bold: "Lance une vérification de véhicule volé NICB", body: " pour confirmer qu'aucun rapport de vol n'existe." },
      { bold: "Valide la continuité de l'odomètre", body: " à travers chaque événement de titre enregistré." },
      { bold: "Paie uniquement par méthodes traçables", body: " \u2014 virement bancaire, chèque de caisse ou escrow que tu as sélectionné indépendamment." },
      { bold: "Inspecte le titre en personne", body: " pour les filigranes, sceaux en relief, altérations et la langue de l'état émetteur correspondante." },
    ],
    s9Outro: "Aucune de ces étapes ne prend plus de quelques minutes individuellement, et le protocole complet attrape régulièrement les arnaques détaillées ci-dessus. En sauter ne serait-ce qu'une est comment des acheteurs autrement prudents finissent par déposer des plaintes auprès de la FTC.",
    s10Heading: "Que faire si tu t'es fait arnaquer",
    s10Intro: "Si tu soupçonnes une fraude après un achat, agis dans les premières 48 heures. Plus tu attends, plus la récupération devient difficile :",
    s10Bullets: [
      "Dépose un rapport auprès des forces de l'ordre locales et obtiens une copie du numéro de rapport.",
      "Soumets une plainte à la Federal Trade Commission sur ReportFraud.ftc.gov et à ton procureur général d'état.",
      "Si la transaction était en ligne, dépose auprès de l'Internet Crime Complaint Center (IC3) du FBI.",
      "Notifie immédiatement ta banque ou ta carte de crédit pour tenter d'inverser tout paiement traçable.",
      "Contacte ton DMV d'état ; si le titre est frauduleux, ils peuvent signaler le VIN et aider à bloquer la réémission.",
      "Considère consulter un avocat en protection du consommateur ; beaucoup prennent des affaires à honoraires conditionnels, en particulier pour la fraude côté concessionnaire où les dommages statutaires s'appliquent.",
    ],
    emergingHeading: "Schémas de fraude émergents à surveiller en 2026",
    emergingIntro: "Les arnaques ci-dessus représentent la majeure partie des pertes actuelles, mais quatre schémas plus récents ont grandi de manière mesurable au cours des 24 derniers mois et méritent une attention spécifique.",
    em1Heading: "Fraude de certificat contrefait",
    em1: "Une variante persistante de basse technologie : le vendeur te remet un rapport d'historique de véhicule imprimé d'un fournisseur reconnu montrant un titre propre. Quiconque a utilisé un éditeur PDF pendant trente secondes peut altérer la date, la liste de marques ou le résumé d'accident. Défense : n'accepte jamais un rapport fourni par le vendeur. Extrais le tien au moment de l'inspection, payé depuis ton compte, et compare les deux côte à côte. Si le vendeur s'oppose à ce que tu extraies un rapport frais indépendant, considère cela comme une réponse à savoir si la transaction vaut la peine d'être complétée. La même logique s'applique aux rapports imprimés fournis par les concessionnaires ; vérifie-les contre ta propre extraction.",
    em2Heading: "Fraude de titre par identité synthétique",
    em2: "La fraude d'identité synthétique combine des données personnelles réelles et fabriquées pour créer une identité fictive qui passe les vérifications de crédit et les écrans d'antécédents du DMV. Appliquée à la fraude au véhicule, les criminels enregistrent des véhicules volés sous une identité synthétique, obtiennent un titre propre et revendent le véhicule via des marketplaces en ligne. La diligence raisonnable de l'acheteur montre un titre propre sans drapeau de vol parce que le vol n'a jamais été connecté au nouveau VIN. La défense est la même triangulation NICB et NMVTIS couverte ci-dessus, plus la vérification physique du VIN contre la plaque du tableau de bord et l'autocollant du chambranle de porte.",
    em3Heading: "Fraude de batterie EV",
    em3: "À mesure que l'inventaire des EV d'occasion grandit, une nouvelle catégorie de fraude a émergé : la fausse déclaration de l'état de la batterie haute tension. Les vendeurs soit réinitialisent l'affichage de l'état de santé (SoH) avant de mettre en annonce, soit listent un véhicule avec un pack récemment échangé d'une épave. Les acheteurs ne découvrent le problème que des semaines plus tard, quand l'autonomie chute dramatiquement en dessous du nombre annoncé. Défense : extrais un rapport SoH tiers depuis le port OBD-II, pas l'affichage du tableau de bord, et vérifie que la garantie haute tension est toujours active et transférable.",
    em4Heading: "Exportation et ré-importation de véhicules de salvage",
    em4: "Un schéma en croissance exporte des véhicules au titre de salvage vers des pays avec des contrôles d'importation faibles, où la paperasse est blanchie, puis les ré-importe comme véhicules \u201Cimportés avec titre propre\u201D. NMVTIS préserve la marque d'origine sur la plupart des historiques américains, mais les allers-retours internationaux peuvent rompre la chaîne dans les dossiers plus anciens ou mal suivis. Si un rapport d'historique montre un événement d'exportation, creuse plus avant de traiter le titre actuel comme faisant autorité.",
    em5Heading: "Annonces deepfake et générées par IA",
    em5Pre: "Les photos et descriptions d'annonces générées par IA ont rendu les fausses annonces en ligne significativement plus difficiles à repérer en un coup d'œil. Les défenses traditionnelles s'appliquent toujours : insiste pour une visite vidéo en direct avec le VIN visible, exige une inspection en personne avant le paiement et refuse tout mode de paiement que le vendeur recommande plutôt qu'un que tu choisis indépendamment. Si un vendeur ne peut pas faire une vidéo en direct de 30 secondes montrant la plaque VIN du tableau de bord sur demande, c'est soit un arnaqueur, soit un vendeur avec qui tu ne veux pas transiger de toute façon. Combine chaque étape d'évaluation en ligne avec une nouvelle ",
    em5Link: "vérification VIN",
    em5Suffix: " que tu lances, jamais une que le vendeur a transférée.",
    em6Heading: "Fraude d'assurance et la collision du consommateur",
    em6p1: "La fraude d'assurance est généralement présentée comme un problème de l'assureur, mais elle a des effets directs en chaîne pour les acheteurs de voitures d'occasion. Les véhicules impliqués dans des accidents simulés, des réclamations fictives de perte totale ou des factures de réparation gonflées finissent de retour sur le marché avec des historiques troubles. La NICB a suivi des réseaux organisés de fraude qui cyclent systématiquement des véhicules à travers des cycles de réclamations pour gonfler la valeur apparente avant la revente. Vérification défensive : examine la section historique d'accidents du rapport pour des groupes de petites réclamations dans des établissements de réparation similaires, en particulier sur de courtes fenêtres de temps. Les motifs qui semblent algorithmiques le sont généralement.",
    em6p2: "L'exposition de l'acheteur à la fraude d'assurance est indirecte mais réelle. Un véhicule avec un historique de réclamations manipulé peut avoir des dommages structurels non documentés, des réparations de châssis cachées ou des pièces de remplacement de provenance inconnue. Combine le rapport d'historique avec une inspection au jauge d'épaisseur de peinture à l'étape pré-achat \u2014 les lectures de panneaux inégales sont peu coûteuses à détecter et trahissent systématiquement le travail de collision passé que le vendeur n'a pas divulgué.",
    em7Heading: "Fraude de vague post-catastrophe",
    em7Pre: "Après les grands ouragans, inondations, tempêtes de grêle et incendies de forêt, la NICB et les procureurs généraux d'état émettent des alertes consommateurs sur une vague prévisible de véhicules endommagés entrant dans le flux de revente. Le motif : les assureurs totalisent des dizaines de milliers de véhicules, les opérateurs de salvage les achètent aux enchères, des réparations cosmétiques suivent et les véhicules sont transportés vers des états bien en dehors de l'empreinte de la catastrophe pour la revente. Les acheteurs dans n'importe quel état peuvent recevoir un véhicule endommagé par inondation dont l'historique remonte à un événement de tempête à 1 500 miles de distance. Croise la chaîne d'états du rapport d'historique contre les grands événements de catastrophe dans la fenêtre de temps pertinente avant de compléter la transaction. Notre ",
    em7Link: "outil d'historique d'accidents",
    em7Suffix: " fait apparaître les enregistrements d'inondation et de dégâts de tempête là où ils sont disponibles.",
    em8Heading: "Construire une routine de vérification personnelle",
    em8: "Les acheteurs qui transigent souvent sur le marché de l'occasion (petits concessionnaires, revendeurs, amateurs) bénéficient de la standardisation de leur flux de vérification. La routine en cinq étapes que nos analystes recommandent : (1) décode le VIN avant de contacter le vendeur, (2) demande des photos avant, arrière et tableau de bord avec un journal du jour ou une note datée visible, (3) lance un appel vidéo en direct de trois minutes pour vérifier les emplacements du VIN en personne, (4) extrais un rapport d'historique complet au moment de l'inspection en personne, pas une semaine avant, et (5) complète le paiement uniquement via le bureau de virement de ta banque ou un chèque de caisse, jamais une méthode tierce introduite par le vendeur. Standardiser la routine attrape environ 95 % des arnaques cataloguées dans ce guide.",
    relatedHeading: "Lectures connexes",
    related: [
      { href: "/stolen-vehicle-check", title: "Vérification de véhicule volé", desc: "Recherche soutenue par NICB des dossiers de vol et de récupération." },
      { href: "/salvage-title-check", title: "Vérification de salvage title", desc: "Repère les marques salvage, rebuilt, junk et inondation." },
      { href: "/odometer-check", title: "Vérification de recul d'odomètre", desc: "Valide de manière croisée chaque lecture d'odomètre NMVTIS." },
      { href: "/accident-history-check", title: "Vérification d'historique d'accidents", desc: "Gravité des dommages, déploiement d'airbag et réparations structurelles." },
      { href: "/guides/used-car-buying-complete-guide", title: "Guide complet d'achat de voiture d'occasion", desc: "Budget jusqu'à la paperasse, de bout en bout." },
      { href: "/guides/car-history-report-guide", title: "Guide du rapport d'historique de véhicule", desc: "Ce qu'il y a dans un rapport et d'où viennent les données." },
      { href: "/blog", title: "Blog CarCheckerVIN", desc: "Recherche fraîche sur les tendances et la prévention de la fraude." },
      { href: "/trust", title: "Confiance et sources de données", desc: "Comment nous nous procurons les données NMVTIS, NICB et OEM." },
    ],
    continueHeading: "Continue à apprendre",
    continuePre: "Besoin d'un regard technique plus approfondi sur une arnaque spécifique ? Commence avec l'outil ",
    continueLink1: "vérification VIN",
    continueMid1: ", passe n'importe quel véhicule par notre ",
    continueLink2: "vérification de rachat lemon law",
    continueMid2: ", ou explore la bibliothèque complète de guides et d'outils sur ",
    continueLink3: "/guides",
    continueSuffix: ".",
    faqHeading: "Questions fréquentes",
    bottomHeading: "Lance un écran antifraude sur n'importe quel VIN",
    bottomSub: "Marques de titre, dossiers d'accidents, continuité d'odomètre et vérifications de véhicules volés \u2014 le tout dans un seul rapport.",
  },
} as const;
...
const FAQS_FR = [
  { question: "Qu'est-ce que le lavage de titre et comment l'éviter ?", answer: "Le lavage de titre est le re-titrage d'un véhicule marqué \u2014 salvage, inondation, junk ou rebuilt \u2014 dans un état avec des règles de marquage plus faibles afin que la marque tombe du nouveau titre à l'apparence propre. Évite-le en lançant une vérification d'historique soutenue par NMVTIS, qui agrège les données de titre des 50 DMV d'état et fait apparaître la marque d'origine même quand le titre papier actuel la cache. Confirme aussi que le titre est émis dans l'état de résidence du vendeur et surveille une chaîne qui rebondit entre trois états ou plus en quelques années." },
  { question: "Qu'est-ce que le clonage de VIN ?", answer: "Le clonage de VIN consiste à copier un VIN légitime d'un véhicule propre et légalement titré sur une voiture volée de même marque et modèle. La voiture volée porte alors une paperasse qui semble valide jusqu'à ce que les forces de l'ordre retracent le vrai VIN et la récupèrent \u2014 laissant l'acheteur sans la voiture ni l'argent. Défends-toi en faisant correspondre physiquement le VIN sur la plaque du tableau de bord, l'autocollant du chambranle de porte conducteur et le titre, en vérifiant les rivets ou la colle altérés et en lançant une vérification de véhicule volé NICB." },
  { question: "Qu'est-ce que le curbstoning ?", answer: "Le curbstoning est quand un concessionnaire sans licence se fait passer pour un vendeur particulier pour se débarrasser de voitures problématiques \u2014 souvent des véhicules avec des titres marqués, des dégâts non divulgués ou des odomètres reculés \u2014 tout en évitant les obligations de lemon law et les protections du consommateur qui s'appliquent aux concessionnaires licenciés. Les signes d'avertissement incluent un vendeur dont le nom ne correspond pas au titre, plusieurs véhicules liés au même numéro de téléphone et un refus de rencontrer à une adresse commerciale enregistrée. Vérifie toujours que le nom du vendeur correspond exactement au titre." },
  { question: "Comment repérer une fraude d'odomètre ?", answer: "Compare le kilométrage affiché à l'historique enregistré du véhicule : chaque transfert de titre NMVTIS capture une lecture d'odomètre, donc un nombre actuel inférieur à un enregistrement antérieur est un recul concluant. Vérifie aussi que l'usure correspond au kilométrage \u2014 un volant poli, une pédale de frein usée ou un renfort de siège affaissé sur une voiture affichant un faible kilométrage ne s'additionne pas. Croise les autocollants de service, les dossiers de vidange d'huile et les cachets d'inspection, qui portent tous un kilométrage qui peut être vérifié contre la lecture du tableau de bord." },
  { question: "Comment une vérification VIN peut-elle me protéger de la fraude aux voitures d'occasion ?", answer: "Une vérification VIN décode l'identité du véhicule contre les dossiers de titre et de marque NMVTIS et les données de vol NICB, faisant apparaître les marques salvage, inondation, lemon et junk, les discontinuités d'odomètre et les rapports de véhicules volés qu'un titre papier peut cacher. Comme NMVTIS agrège les données des 50 DMV d'état, il bat le lavage de titre inter-états. Extrais toujours le rapport toi-même au moment de l'inspection \u2014 ne fais jamais confiance à un rapport imprimé que le vendeur te remet, qui peut être altéré en quelques secondes avec un éditeur PDF." },
  { question: "Que devrais-je vérifier avant de payer pour une voiture d'occasion ?", answer: "Confirme que le VIN correspond sur la plaque du tableau de bord, l'autocollant du chambranle de porte, l'estampage du compartiment moteur, le titre, l'enregistrement et la facture de vente. Extrais un rapport d'historique complet soutenu par NMVTIS et lance une vérification de véhicule volé NICB. Valide que chaque lecture d'odomètre enregistrée tend vers le haut. Obtiens une inspection pré-achat indépendante d'un mécanicien qui n'est pas le garage du vendeur. Inspecte le titre en personne pour les filigranes, sceaux en relief et altérations. Paie uniquement par méthodes traçables \u2014 virement bancaire ou chèque de caisse, jamais cartes-cadeaux ou crypto." },
  { question: "Quelles sont les arnaques courantes d'achat de voiture en ligne ?", answer: "Les arnaques en ligne les plus courantes partagent une forme : un prix bien en dessous du marché, un vendeur indisponible pour une visite en personne (invoquant un déploiement militaire, une maladie ou un déménagement) et une pression pour utiliser un escrow tiers ou un service d'expédition qui met ton argent hors de portée. Surveille les faux sites d'escrow, les annonces avec des photos volées ou de stock, les factures utilisant le logo d'une vraie entreprise depuis le mauvais domaine, et les demandes de virements bancaires, cartes-cadeaux ou cryptomonnaies. La règle centrale : si tu ne peux pas inspecter physiquement la voiture et vérifier le VIN en personne, n'envoie pas d'argent." },
];
