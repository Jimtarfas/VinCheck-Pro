...
const COPY = {
  ...
  fr: {
    home: "Accueil", tools: "Outils", crumb: "\u00C9tiquette Monroney gratuite par VIN",
    badge: "100% Gratuit   \u00B7   \u00C9tiquette Monroney   \u00B7   Par VIN",
    h1Lead: "\u00C9tiquette Monroney gratuite ", h1Accent: "par VIN",
    intro: "Obtiens l'\u00E9tiquette Monroney d'origine de n'importe quel v\u00E9hicule gratuitement, directement depuis son VIN. Entre un VIN de 17 caract\u00E8res pour obtenir le MSRP de base, les options et packs d'usine, l'\u00E9quipement standard et la consommation EPA \u2014 pour Toyota, Ford, Chevy, Honda, BMW, Chrysler, Dodge et tout v\u00E9hicule du march\u00E9 am\u00E9ricain. Imprime ou enregistre en PDF, sans frais par rapport.",
    ctaTop: "Obtenir l'\u00E9tiquette gratuite",
    ctaTopNote: "Gratuit \u00B7 Sans carte de cr\u00E9dit \u00B7 R\u00E9sultat instantan\u00E9",
    trustStats: [
      { value: "$0", label: "toujours gratuit" },
      { value: "Par VIN", label: "d\u00E9codage 17 car." },
      { value: "Toutes marques", label: "march\u00E9 \u00C9.-U." },
      { value: "PDF", label: "imprime ou enregistre" },
    ],
    quickAnswer: "R\u00E9ponse rapide",
    quickAnswerBold: "Pour obtenir une \u00E9tiquette Monroney gratuite par VIN, entre le VIN de 17 caract\u00E8res du v\u00E9hicule et d\u00E9code-le.",
    quickAnswerBody: " Tu obtiens l'\u00E9tiquette Monroney d'origine \u2014 MSRP de base, options et packs d'usine, \u00E9quipement standard et consommation EPA \u2014 pour toute voiture, camion ou SUV du march\u00E9 am\u00E9ricain construit depuis 1981. G\u00E9n\u00E9rer et pr\u00E9visualiser l'\u00E9tiquette est compl\u00E8tement gratuit sans frais par VIN ; un compte email gratuit (sans carte de cr\u00E9dit) est n\u00E9cessaire uniquement pour l'imprimer ou l'enregistrer en PDF. Les marques couvertes incluent Toyota, Ford, Chevy, Honda, BMW, Chrysler et Dodge.",
    h2How: "Comment obtenir une \u00E9tiquette Monroney gratuite par VIN",
    howIntro: "L'\u00E9tiquette Monroney d'origine vit dans le registre de construction du fabricant, li\u00E9e au VIN. Trois \u00E9tapes gratuites transforment ce code en l'\u00E9tiquette avec laquelle la voiture a \u00E9t\u00E9 vendue.",
    howSteps: [
      { tag: "\u00C9tape 1", title: "Entre le VIN", body: "Colle n'importe quel VIN de 17 caract\u00E8res dans le champ de remplissage auto. Le d\u00E9codage gratuit se connecte au registre de construction d'usine pour ce v\u00E9hicule exact." },
      { tag: "\u00C9tape 2", title: "D\u00E9code gratuitement", body: "Un clic extrait l'ann\u00E9e, la marque, le mod\u00E8le, la finition, le moteur, le MSRP, les options d'usine, l'\u00E9quipement standard et la consommation EPA \u2014 sans frais, sans frais par VIN." },
      { tag: "\u00C9tape 3", title: "Imprime ou enregistre en PDF", body: "Connecte-toi avec un compte gratuit, puis exporte une \u00E9tiquette Monroney propre d'une seule page \u00E0 imprimer ou enregistrer en PDF pour les annonces, registres ou affichage." },
    ],
    h2Included: "Ce qui est inclus gratuitement",
    includedIntro: "L'\u00E9tiquette VIN gratuite reconstruit chaque bloc de l'\u00E9tiquette Monroney d'origine exig\u00E9e par la loi f\u00E9d\u00E9rale \u2014 rien retenu derri\u00E8re un paywall.",
    included: [
      { title: "MSRP original et prix", body: "MSRP de base, total de toutes les options d'usine, frais de destination et le prix total d'\u00E9tiquette que portait le v\u00E9hicule neuf." },
      { title: "Options et packs d'usine", body: "Chaque option install\u00E9e en usine et pack group\u00E9 avec son prix individuel \u2014 d\u00E9taill\u00E9 exactement comme l'\u00E9tiquette d'origine." },
      { title: "\u00C9quipement standard", body: "Les caract\u00E9ristiques de s\u00E9curit\u00E9, confort, technologie et commodit\u00E9 incluses sans frais avec la finition de base." },
    ...
    midCtaTag: "Toujours gratuit", midCtaHeading: "Obtiens une \u00E9tiquette Monroney gratuite par VIN",
    midCtaSub: "MSRP original, options d'usine et consommation EPA en secondes \u2014 sans frais, sans carte de cr\u00E9dit.",
    midCtaBtn: "L'obtenir gratuitement",
    h2FreeVsPaid: "Gratuit par VIN vs rapports d'\u00E9tiquette Monroney payants",
    freeVsPaidP1: "Carfax et plusieurs outils de concessionnaires regroupent l'\u00E9tiquette Monroney dans un rapport payant et facturent par VIN \u2014 et la sortie est en vue seule. Cet outil reconstruit la m\u00EAme \u00E9tiquette style Monroney depuis le VIN gratuitement, et te permet de la modifier et l'exporter.",
    freeVsPaidP2Pre: "Le pi\u00E8ge est petit et honn\u00EAte : construire et pr\u00E9visualiser est ouvert \u00E0 tous, et un compte email gratuit est requis uniquement \u00E0 l'\u00E9tape de t\u00E9l\u00E9chargement. Il n'y a pas de paiement ni de filigrane. Combine l'\u00E9tiquette gratuite avec un ",
    freeVsPaidP2Link: "rapport d'historique VIN",
    freeVsPaidP2Suffix: " complet pour l'image compl\u00E8te.",
    freeVsPaidCardTitle: "Ce pour quoi tu ne paies pas",
    freeVsPaidBullets: [
      "Sans frais de rapport par VIN \u2014 g\u00E9n\u00E8re autant d'\u00E9tiquettes que tu veux",
      "Sans carte de cr\u00E9dit, jamais \u2014 un compte email gratuit d\u00E9verrouille les t\u00E9l\u00E9chargements",
      "Modifie chaque champ apr\u00E8s d\u00E9codage, contrairement aux rapports payants en vue seule",
      "Imprime ou enregistre en PDF, plus une copie HTML portable",
      "Fonctionne pour chaque marque du march\u00E9 am\u00E9ricain et ann\u00E9e mod\u00E8le depuis 1981",
      "Sans filigrane sur l'\u00E9tiquette finie",
    ],
    h2Internal: "Outils gratuits qui se combinent avec ton \u00E9tiquette Monroney",
    internalIntro: "L'\u00E9tiquette est une pi\u00E8ce. Ces outils gratuits compl\u00E8tent l'image avant d'acheter ou d'annoncer.",
    internalLinks: [
      { href: "/window-sticker-lookup", label: "Recherche d'\u00E9tiquette Monroney", desc: "Le parcours ax\u00E9 sur la recherche, avec des conseils marque par marque et une comparaison gratuit-vs-payant." },
      ...
      { href: "/recall-check", label: "V\u00E9rification de rappels", desc: "Rappels de s\u00E9curit\u00E9 NHTSA ouverts pour le m\u00EAme VIN \u2014 r\u00E9par\u00E9s gratuitement par le concessionnaire." },
    ],
    h2Faq: "\u00C9tiquette Monroney gratuite par VIN \u2014 Questions fr\u00E9quentes",
    faqIntro: "Les questions que les gens posent le plus sur l'obtention d'une \u00E9tiquette Monroney gratuite depuis un VIN.",
    bottomBadge: "Gratuit \u00B7 Instantan\u00E9 \u00B7 Par VIN",
    bottomHeading: "Obtiens ton \u00E9tiquette Monroney gratuite par VIN",
    bottomSub: "Entre un VIN de 17 caract\u00E8res pour obtenir l'\u00E9tiquette Monroney d'origine \u2014 MSRP, options d'usine et consommation EPA \u2014 puis imprime ou enregistre en PDF, sans frais.",
    bottomCta: "L'obtenir gratuitement",
  },
} as const;
