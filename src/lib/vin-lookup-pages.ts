...
export const VIN_LOOKUP_PAGES: LookupPage[] = [
  // ───────────────────────── ATTRIBUTE: PARTS ─────────────────────────
  {
    ...
    keywords: [
      ...
      "vin number parts",
      "auto parts vin lookup",
      "car parts vin lookup",
      "part number lookup by vin",
      "oem part number lookup by vin",
      "lookup part by vin",
      "auto part lookup by vin",
      "car part vin lookup",
      "vin number part lookup",
      "vin part lookup",
      "ford parts lookup by vin",
      "ford parts vin lookup",
      "ford part lookup by vin",
      "ford vin parts lookup",
    ],
    intro:
  ...
  // ───────────────────────── TYPE: TRUCK ─────────────────────────
  {
    ...
    keywords: [
      ...
      "truck lookup by vin",
      "vin truck lookup",
      "commercial vehicle vin lookup",
      "commercial vin lookup",
      "vin lookup international truck",
      "chevrolet truck vin lookup",
      "dodge truck vin lookup",
      "truck vin lookup free",
    ],
    intro:
  ...
  // ───────────────────────── TYPE: TRAILER ─────────────────────────
  {
    ...
    keywords: [
      ...
      "vin trailer lookup",
      "lookup trailer vin",
      "vin number trailer lookup",
      "vin lookup for trailer",
      "trailer vin lookup texas",
    ],
    intro:
  ...
  // ───────────────────────── ATTRIBUTE: ENGINE ─────────────────────────
  {
    ...
    keywords: [
      ...
      "lookup engine by vin",
      "vin number engine lookup",
      "vin lookup for engine size",
      "lookup engine size by vin",
      "vin lookup for engine type",
    ],
    intro:
  ...
  // ───────────────────────── ATTRIBUTE: SPECS ─────────────────────────
  {
    ...
    keywords: [
      ...
      "vin lookup for specs",
      "vin number lookup for specifications",
      "lookup car specs by vin",
      "vehicle specs vin lookup",
      "vin lookup for car specs",
      "vehicle vin lookup specs",
      "vin car specs lookup",
      "vin number specs lookup",
      "vin specs lookup",
      "vin lookup car specs",
      "vin lookup vehicle specs",
      "can i lookup my vehicle specs by vin number",
      "vin detail lookup",
      "vin lookup for vehicle specs",
    ],
    intro:
  ...
  // ───────────────────────── ATTRIBUTE: OPTIONS ─────────────────────────
  {
    ...
    keywords: [
      ...
      "vin option lookup",
      "vin lookup to see factory options",
      "vin lookup options",
      "lookup car options by vin",
      "vin features lookup",
      "vin lookup features",
      "feature lookup by vin",
      "lookup car features by vin",
      "lookup car features by vin number",
      "vin equipment lookup",
    ],
    intro:
  ...
  // ───────────────────────── ATTRIBUTE: GVWR ─────────────────────────
  {
    ...
    keywords: [
      ...
      "lookup gvwr by vin",
      "gross vehicle weight lookup by vin",
      "gross weight lookup by vin",
    ],
    intro:
  ...
  // ───────────────────────── ATTRIBUTE: REGISTRATION ─────────────────────────
  {
    ...
    keywords: [
      ...
      "vehicle registration lookup by vin",
    ],
    intro:
  ...
  // ───────────────────────── ATTRIBUTE: DMV ─────────────────────────
  {
    ...
    keywords: [
      ...
      "vin number lookup dmv",
      "dmv lookup vin",
      "free vin number lookup dmv",
      "dmv license plate lookup by vin",
    ],
    intro:
