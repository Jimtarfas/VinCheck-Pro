...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: "Edmunds VIN Lookup — Pair Valuation With Free History", description: "How the Edmunds VIN lookup and True Market Value calculator work, what they do not cover, and how a free NMVTIS-sourced history check changes the appraisal.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE}/edmunds-vin-lookup` }, datePublished: "2026-06-15", dateModified: "2026-06-28" };
