...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: "Vehicle History Report by VIN", description: "Learn what a vehicle history report is, what it includes, where the data comes from, how to read it, and how to run one free by VIN before you buy a used car.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE}/vehicle-history-report` }, datePublished: "2026-06-25", dateModified: new Date().toISOString().slice(0, 10) };
