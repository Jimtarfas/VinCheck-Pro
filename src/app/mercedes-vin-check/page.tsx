...
const TITLE = "Mercedes-Benz VIN Check & Decoder — Free by Model";
const DESCRIPTION =
  "Free Mercedes-Benz VIN check. Decode any Mercedes by model — C-Class, E-Class, GLC, GLE, S-Class and more — and reveal salvage, flood, buyback & accident brands. NMVTIS-backed, instant, no signup.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "decode Mercedes VIN",
    "Mercedes VIN lookup",
    "Mercedes VIN number check",
    "free Mercedes VIN check",
    "Mercedes-Benz history report",
    "Mercedes salvage check",
  ],
  alternates: { canonical: "/mercedes-vin-check" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    url: `${SITE}/mercedes-vin-check`,
    type: "website",
...
export default function MercedesVinHubPage() {
  const pageUrl = `${SITE}/mercedes-vin-check`;
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Mercedes-Benz VIN Check", item: pageUrl },
    ],
  };
  ...
  const itemListSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Mercedes-Benz VIN Check by Model",
    description: "Model-specific VIN check and decoder guides for popular Mercedes-Benz vehicles.",
    itemListElement: MERCEDES_MODELS.map((m, i) => ({
      "@type": "ListItem",
      position: i + 1,
        ...
        <div className="bg-primary text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-24 pb-14 sm:pt-28 sm:pb-20">
            <Breadcrumbs
              items={[
                { label: "Home", href: "/" },
                { label: "Mercedes-Benz VIN Check" },
              ]}
              onDark
            />

            <div className="mt-6 inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 text-sm font-bold mb-4">
              <Fingerprint className="w-4 h-4" /> Mercedes-Benz VIN Decoder &amp; History
            </div>

            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-headline font-extrabold leading-tight mb-4">
              Mercedes-Benz VIN Check —{" "}
              <span style={{ color: "var(--color-secondary-container)" }}>
                Decode Any Mercedes by Model
              </span>
            </h1>

            <p className="speakable-intro text-base sm:text-xl text-white/85 max-w-3xl mb-8 leading-relaxed">
              Run a free Mercedes-Benz VIN check to decode the year, engine, and
              trim of any Mercedes, and reveal salvage, flood, lemon-law buyback,
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-7 shadow-xl">
              <h2 className="text-base sm:text-lg font-headline font-extrabold text-primary mb-1">
                Run a Free Mercedes-Benz VIN Check
              </h2>
              <p className="text-xs sm:text-sm text-on-surface-variant mb-4">
                Enter any 17-character Mercedes-Benz VIN
              </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <section className="py-12 sm:py-16 border-b border-outline-variant">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {MERCEDES_MODELS.map((m) => (
                <Link
                  key={m.slug}
                  href={`/mercedes-vin-check/${m.slug}`}
          ...
          <section className="py-12 sm:py-16 border-b border-outline-variant">
            ...
            <div className="prose prose-slate max-w-none text-sm sm:text-base text-on-surface-variant leading-relaxed space-y-4">
              <p>
                ...
                A VIN check is the fastest way to tell a genuinely clean Mercedes
                from a rebuilt one for the specific car you are considering.
              </p>
              <p>
                The first three characters of any Mercedes-Benz VIN are the World
                Manufacturer Identifier (WMI), assigned by plant and country — a
                German-built Mercedes typically opens with{" "}
                <strong className="text-on-surface">W</strong> (such as WDD, WDC,
                W1K, or W1N), while the US-built GLE and GLS from Tuscaloosa,
                Alabama open with <strong className="text-on-surface">4JG</strong>.
          ...
          <section className="py-10">
            <div className="rounded-3xl bg-primary p-7 sm:p-10 text-center">
              ...
              <h2 className="text-2xl sm:text-3xl font-headline font-extrabold text-white mb-2">
                Check Any Mercedes-Benz in Seconds
              </h2>
              <p className="text-white/80 text-sm sm:text-base mb-6 max-w-xl mx-auto">
                Free, instant Mercedes-Benz VIN check sourced from NMVTIS and
          ...
          <section className="py-14 sm:py-20 text-center">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary rounded-full px-4 py-1.5 text-xs font-black uppercase tracking-wider mb-4">
              <Zap className="w-3.5 h-3.5" /> Free · Instant · Mercedes-Benz
            </div>
            <h2 className="text-2xl sm:text-4xl font-headline font-extrabold text-primary mb-3">
              One VIN. Your Mercedes&apos;s Full History. Five Seconds.
            </h2>
