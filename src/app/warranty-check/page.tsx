...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "en", headline: "Warranty Check by VIN — Is This Car Still Under Warranty?", description: "How to check warranty status by VIN, what each factory coverage includes, how the in-service date and mileage set remaining coverage, transfer rules, and what voids a manufacturer warranty.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: new Date().toISOString().slice(0, 10) };
