...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "en", headline: "Ford Build Sheet by VIN — Door Data Plate, DSO & Marti Report", description: "How to read a Ford build sheet by VIN: the door data plate, DSO district code, axle and transmission codes, paint and trim, and the Marti Report that reconstructs the original factory order for 1967-up Ford vehicles.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-06-12", dateModified: new Date().toISOString().slice(0, 10) };
