...
export const metadata: Metadata = {
  ...
  keywords: ["VIN recall check", "NHTSA recall lookup", "open recall by VIN", "safety recall check", "vehicle recall search", "car recall VIN", "Takata airbag recall check", "is my car under recall"],
