...
const COPY = {
  ...
  fr: {
    modeHeading: "Mode calculatrice",
    modeDaily: "Coût de conduite quotidien",
    modeDailySub: "hebdomadaire et annuel",
    modeTrip: "Coût de road trip",
    modeTripSub: "aller simple ou aller-retour",
    yourVehicle: "Ton véhicule",
    mpgLabel: "Consommation (MPG)",
    mpgHint: "Trouve-le sur l'étiquette de vitrine ou fueleconomy.gov",
    milesPerDay: "Miles par jour",
    drivingDays: "Jours de conduite / semaine",
    dayUnit: (d: number) => `${d} jour${d !== 1 ? "s" : ""}`,
    tripDistance: "Distance du trajet (miles)",
    gasPrice: "Prix de l'essence",
    stateAverage: "Moyenne de l'état",
    customPrice: "Ou saisis un prix personnalisé",
    usingPrice: "Utilisation :",
    perGallon: "/gallon",
    customLabel: "(personnalisé)",
    hideCompare: "Masquer",
    showCompare: "Comparer avec un autre véhicule (facultatif)",
    vehicleBMpg: "Véhicule B — MPG",
    priceDiff: "Différence de prix ($)",
    priceDiffHint: "Combien le Véhicule B coûte de plus à acheter",
    ...
    monthlySub: "basé sur la moyenne annuelle",
    annualCost: "Coût annuel",
    gallonsPerYear: "gallons/an",
    costPerMile: "Coût par mile",
    fuelOnly: "carburant uniquement",
    co2Pre: "À",
    co2Mid: "MPG, ton véhicule émet environ",
    co2LbsLabel: "lbs de CO₂",
    co2PerYear: "par an",
    co2Tons: "tonnes métriques",
    co2Compare: "). La voiture particulière moyenne selon l'EPA émet environ 4,6 tonnes métriques par an.",
    comparison: "Comparaison de véhicules",
    vehicleA: "Véhicule A",
    vehicleB: "Véhicule B",
    annualSavings: "Économies annuelles",
    perYear: "/an",
    payOffPre: "Le Véhicule B rembourse son",
    payOffPremium: "supplément",
    payOffMid: "en économies de carburant après",
    payOffMonths: "mois",
    payOffYears: "ans).",
    longPaybackPre: "Aux prix actuels du carburant, il faudrait",
    longPaybackMid: "mois",
    longPaybackEnd: "pour récupérer le supplément de prix — plus long que la plupart des gens gardent un véhicule.",
    lowMpgTitle: "Ta consommation est sous la moyenne",
    lowMpgBody1: "La voiture particulière américaine moyenne atteint environ 28 MPG. Passer à 35 MPG ferait économiser environ",
    lowMpgBody2: "/an aux prix actuels de l'essence. Pense à vérifier la pression des pneus, remplacer les filtres à air et éviter les accélérations brusques.",
    crossLinkLead: "Tu prévois d'acheter une voiture plus économe en carburant ?",
    crossLinkBold: "Calcule ce que tu peux te permettre.",
    crossLinkBtn: "Calc. d'accessibilité",
  },
} as const;
