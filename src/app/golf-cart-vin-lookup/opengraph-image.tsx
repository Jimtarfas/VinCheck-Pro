    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Golf carts use a serial number, not a road VIN. Find it and decode
            the model year on any Club Car, E-Z-GO &amp; Yamaha.
          </div>
        </div>

        <div style={{ display: "flex", gap: 16, fontSize: 22, flexWrap: "wrap" }}>
          {["Club Car decoder", "E-Z-GO + Yamaha", "Model Year", "Free"].map(
            (t) => (
              <div
                key={t}
                style={{
