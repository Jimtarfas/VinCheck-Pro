...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: "Paint Code Lookup by VIN — Find Your Factory Color", description: "Interactive paint code locator for 30+ brands and a VIN-based lookup that returns the exact OEM paint code from the manufacturer's build database.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-04-16", dateModified: "2026-06-25" };
