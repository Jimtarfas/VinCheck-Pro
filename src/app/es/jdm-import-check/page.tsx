...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "es", headline: "Verificación VIN de importación JDM — Historial vehículos importados de Japón", description: "Cómo verificar el historial de vehículos de importación del Mercado Doméstico Japonés: verificación de kilometraje en kilómetros, códigos de chasis versus el VIN de 17 caracteres, hojas de subasta japonesas, la regla de importación de 25 años y estado de cumplimiento en EE. UU.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: new Date().toISOString().slice(0, 10) };
