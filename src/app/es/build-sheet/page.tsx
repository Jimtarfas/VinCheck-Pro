...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "es", headline: "Hoja de fabricación por VIN — Registro original de fábrica", description: "Cómo buscar la hoja de fabricación original de cualquier vehículo por VIN, qué contiene, en qué se diferencia de la etiqueta de ventana, y por qué los coleccionistas y restauradores dependen de ella.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-06" };
