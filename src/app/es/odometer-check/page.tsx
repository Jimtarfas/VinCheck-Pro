...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "es", headline: "Verificación de odómetro y kilometraje por VIN", description: "Aprende cómo funciona el fraude de odómetro, cómo una verificación VIN detecta rollback, qué señales físicas buscar y qué hacer si detectas una discrepancia.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-04-16", dateModified: "2026-06-09" };
