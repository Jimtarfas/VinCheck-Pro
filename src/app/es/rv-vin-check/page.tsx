...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "es", headline: "Verificación VIN de casa rodante y motorhome", description: "Cómo verificar cualquier casa rodante, motorhome, remolque de viaje o camper por VIN — incluyendo marcas de título, historial de accidentes, gravámenes, recalls y la distinción chasis vs. coach única de las casas rodantes motorizadas.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-25" };
