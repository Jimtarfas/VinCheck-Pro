/**
 * Shared renderer for Wave 14 Spanish info/marketing/legal pages.
      ...
      {hook.legalCanonical && (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mt-6">
          <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-900">
            ...
            <div>
              <p className="font-bold mb-1">Traducción de cortesía — versión canónica en inglés</p>
              <p>
                Esta página es un resumen en español. El documento legalmente
