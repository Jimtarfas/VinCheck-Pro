/**
 * Shared <StatePage /> component for the Big-5 Spanish state pages.
 * Renders the entire body — hero, why-different bullets, what's
 * included grid, sources panel, bottom CTA — from a single STATE_HOOKS_ES
 * entry plus the global `state.*` dictionary chrome.
 *
 * Each /es/<state>-revision-vin/page.tsx becomes a thin wrapper that just
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-24 pb-14 sm:pt-28 sm:pb-20">
          <Breadcrumbs
            items={[
              ...
              { label: `Revisión VIN de ${hook.stateNameEs}` },
            ]}
            onDark
          />
