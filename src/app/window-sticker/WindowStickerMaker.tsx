...
const COPY = {
  ...
  fr: {
    ...
    reset: "R\u00e9initialiser",
    autofillLabel: "Auto-remplir depuis le VIN",
    vinPlaceholder: "VIN de 17 caract\u00e8res",
    decode: "D\u00e9coder",
    decodeError: "Saisis un VIN de 17 caract\u00e8res pour auto-remplir.",
    decodeErrorGeneric: "Impossible de d\u00e9coder ce VIN.",
    autofillNote: "Nous remplirons l'ann\u00e9e, la marque, le mod\u00e8le, le moteur, le MSRP, le MPG et l'\u00e9quipement depuis le fichier usine \u2014 tu peux tout modifier ensuite.",
    secIdentification: "Identification",
    secMechanical: "M\u00e9canique",
    secPricing: "Prix",
    secStandardEquipment: "\u00c9quipement de s\u00e9rie",
    secOptionalEquipment: "\u00c9quipement en option",
    secFuelEconomy: "Consommation (EPA)",
    secWarranty: "Garantie",
    secOrigin: "Origine (optionnel)",
    fYear: "Ann\u00e9e", fMake: "Marque", fModel: "Mod\u00e8le", fTrim: "Finition / Style",
    fBodyStyle: "Type de carrosserie", fDrivetrain: "Transmission", fEngine: "Moteur", fTransmission: "Bo\u00eete",
    fExteriorColor: "Couleur ext\u00e9rieure", fInteriorColor: "Couleur int\u00e9rieure",
    fBaseMsrp: "MSRP de base ($)", fDestination: "Frais de destination ($)",
    fCityMpg: "MPG ville", fHwyMpg: "MPG autoroute", fCombinedMpg: "MPG combin\u00e9",
    fFuelType: "Type de carburant", fAnnualFuelCost: "Co\u00fbt annuel de carburant ($)",
    fWarrantyBasic: "De base / pare-chocs \u00e0 pare-chocs", fWarrantyPowertrain: "Groupe motopropulseur",
    fWarrantyCorrosion: "Corrosion / perforation par rouille", fWarrantyRoadside: "Assistance routi\u00e8re",
    fAssembledIn: "Assembl\u00e9 \u00e0", fPlantCode: "Code d'usine",
    fDealerName: "Nom du concessionnaire", fDealerLocation: "Emplacement du concessionnaire",
    onePerLine: "Un \u00e9l\u00e9ment par ligne",
    option: "Option", remove: "Retirer",
    optName: "Nom de l'option ou du pack", optPrice: "Prix",
    addOption: "Ajouter une autre option",
    livePreview: "Aper\u00e7u en direct",
    accountRequired: "Compte gratuit requis pour t\u00e9l\u00e9charger ou imprimer",
    downloadPdf: "T\u00e9l\u00e9charger le PDF", generating: "G\u00e9n\u00e9ration\u2026", print: "Imprimer",
    captureError: "Impossible de g\u00e9n\u00e9rer le PDF \u2014 r\u00e9essaie.",
    captureErrorPrint: "Impossible de g\u00e9n\u00e9rer l'image d'impression \u2014 r\u00e9essaie.",
    elementNotFound: "\u00c9l\u00e9ment d'\u00e9tiquette introuvable. R\u00e9essaie.",
    imageError: "L'export de l'image a \u00e9chou\u00e9. R\u00e9essaie.",
    genericError: "Un probl\u00e8me est survenu. R\u00e9essaie.",
    previewDisclaimer: "Cette \u00e9tiquette de vitre est g\u00e9n\u00e9r\u00e9e \u00e0 partir des donn\u00e9es que tu as saisies. C'est une r\u00e9plique style Monroney pour usage personnel, annonce ou affichage \u2014 ce n'est pas un document \u00e9mis par le constructeur. Utilise \u00ab\u00a0Imprimer / Enregistrer en PDF\u00a0\u00bb pour l'export le plus propre.",
    miniLive: "Aper\u00e7u en direct", miniTotal: "Total", miniView: "Voir", miniDefault: "Ton v\u00e9hicule",
    miniAria: "Faire d\u00e9filer vers l'aper\u00e7u complet de l'\u00e9tiquette",
    authSignupTitle: "Inscris-toi pour t\u00e9l\u00e9charger ton \u00e9tiquette",
    authLoginTitle: "Connecte-toi pour t\u00e9l\u00e9charger ton \u00e9tiquette",
    authSignupSub: "Cr\u00e9e un compte gratuit en quelques secondes \u2014 sans carte. Ton compte d\u00e9bloque les t\u00e9l\u00e9chargements illimit\u00e9s d'\u00e9tiquettes.",
    authLoginSub: "Bon retour. Connecte-toi pour continuer et t\u00e9l\u00e9charger ton \u00e9tiquette.",
    tabSignup: "S'inscrire", tabLogin: "Se connecter",
    badgeFreeForever: "Gratuit pour toujours", badgeUnlimited: "T\u00e9l\u00e9chargements illimit\u00e9s", badgeNoCard: "Sans carte de cr\u00e9dit",
    close: "Fermer",
    stickerTitle: "\u00c9TIQUETTE VEHICULE MONRONEY \u00b7 WINDOW STICKER",
    baseMsrpLabel: "MSRP DE BASE",
    vinHeader: "NUM\u00c9RO D'IDENTIFICATION DU V\u00c9HICULE",
    vehicleDescription: "DESCRIPTION DU V\u00c9HICULE",
    standardEquipmentHeader: "\u00c9QUIPEMENT DE S\u00c9RIE",
    optionalEquipmentHeader: "\u00c9QUIPEMENT EN OPTION",
    priceInformation: "INFORMATIONS DE PRIX",
    basePrice: "Prix de base", totalOptions: "Total des options", destinationCharge: "Frais de destination",
    totalVehiclePrice: "PRIX TOTAL DU V\u00c9HICULE",
    fuelEconHeader: "Consommation & Environnement",
    combinedLbl: "Combin\u00e9", cityLbl: "Ville", highwayLbl: "Autoroute", mpgLbl: "MPG",
    annualFuelLbl: "Co\u00fbt annuel est. de carburant", fiveYearLbl: "Co\u00fbt carburant sur 5 ans",
    fuelTypeLbl: "Type de carburant\u00a0:", basedOn: "Bas\u00e9 sur 15\u00a0000 mi/an \u00b7 fueleconomy.gov",
    warrantyHeader: "COUVERTURE DE GARANTIE",
    warrantyBasic: "De base", warrantyPowertrain: "Groupe motopropulseur",
    warrantyCorrosion: "Corrosion", warrantyRoadside: "Assistance",
    addWarranty: "Ajoute les termes de garantie dans le formulaire\u2026",
    addStandard: "Ajoute l'\u00e9quipement de s\u00e9rie dans le formulaire\u2026",
    addOptions: "Ajoute les packs optionnels dans le formulaire\u2026",
    scanQr: "Scanne pour ouvrir l'\u00e9tiquette", replicaOnly: "R\u00e9plique \u00e0 des fins d'affichage uniquement",
    rowEngine: "Moteur", rowTransmission: "Bo\u00eete", rowDrivetrain: "Transmission",
    rowExterior: "Ext\u00e9rieur", rowInterior: "Int\u00e9rieur", rowAssembledIn: "Assembl\u00e9 \u00e0",
...
type CopyT = (typeof COPY)["en" | "es" | "fr"];
