...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: "VIN Number Lookup — Free VIN Search Tool, Instant Results", description: "What a free VIN number lookup actually shows, how the data reaches your report, and how to use the result confidently before you buy a used vehicle.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE}/vin-number-lookup` }, datePublished: "2026-06-15", dateModified: new Date().toISOString().slice(0, 10) };
