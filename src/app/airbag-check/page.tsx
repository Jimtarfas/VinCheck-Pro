...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "en", headline: "Airbag & Deployment Check by VIN", description: "Learn how to check airbag deployment history by VIN, why it matters, the common forms of airbag fraud, and how to verify the SRS system was correctly restored.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: new Date().toISOString().slice(0, 10) };
