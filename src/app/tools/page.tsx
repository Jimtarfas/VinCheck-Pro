...
const tools = [
  ...
  {
    icon: MapPin,
    title: "Golf Cart VIN Lookup",
    description:
      "Golf carts use a serial number, not a road VIN. Decode a Club Car serial for the model year instantly, with E-Z-GO and Yamaha brand guides.",
    href: "/golf-cart-vin-lookup",
    cta: "Decode a Cart Serial",
  },
];
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-700 text-white pt-28 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-5 [&_a]:text-primary-100 [&_a:hover]:text-white [&_span]:text-white [&_li_span]:text-primary-200">
            <Breadcrumbs onDark items={[{ label: "Home", href: "/" }, { label: "Free Tools" }]} />
          </div>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-lg text-slate-600 leading-relaxed">
            ...
            should not be locked behind a thirty-dollar paywall. The thirteen tools below cover the
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-lg text-slate-600 leading-relaxed">
              Thirteen tools, zero accounts required. Click any card to jump straight into the tool.
            </p>
          </div>
