...
const title = "Hoja de difusión Mopar par VIN — Etiqueta du guardabarros et codes de fabricación (Dodge, Plymouth, Chrysler)";
const description = "Busca una hoja de difusión Mopar par VIN, gratuit. Décode la etiqueta du guardabarros, codes SO et de vente, codes de peinture et tapicería, et la hoja de difusión original pour Dodge, Plymouth et Chrysler, adeplus de comment le enregistrement Chrysler et les enregistrements de fabricación autentican un auto avec numéros coincidentes.";

export const metadata: Metadata = {
  title, description,
  keywords: ["hoja de difusión Mopar par VIN", "décoder etiqueta du guardabarros Dodge", "hoja de fabricación Plymouth", "enregistrement de fabricación Chrysler", "codes de vente Mopar", "numéro SO Mopar", "décoder etiqueta du guardabarros", "hoja de difusión Charger", "etiqueta du guardabarros Challenger", "code de peinture Mopar", "décoder opciones VIN Mopar", "opciones de fábrica Mopar par VIN", "codes de fabricación Mopar", "décodeur VIN Mopar"],
  alternates: { canonical: alt.canonical, languages: alt.languages },
  openGraph: { title: "Hoja de difusión Mopar par VIN — Etiqueta du guardabarros et codes de fabricación", description: "Décode una hoja de difusión Mopar par VIN: etiqueta du guardabarros, codes SO et de vente, peinture et tapicería, et enregistrements de fabricación pour Dodge, Plymouth et Chrysler.", url: PAGE_URL, type: "article", siteName: "CarCheckerVIN", locale: "fr_US" },
  twitter: { card: "summary_large_image", title: "Hoja de difusión Mopar par VIN — Etiqueta du guardabarros et codes de fabricación", description: "Décode una hoja de difusión Mopar par VIN: etiqueta du guardabarros, codes SO et de vente, peinture et tapicería, et enregistrements de fabricación pour Dodge, Plymouth et Chrysler." },
  robots: { index: true, follow: true },
};

const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Hoja de difusión Mopar par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", operatingSystem: "All", description: "Recupera un enregistrement de fabricación Mopar usando su VIN. Décode la etiqueta du guardabarros, le numéro SO (orden de programación), les codes de vente, les codes de peinture et tapicería, et la hoja de difusión original pour véhicules Dodge, Plymouth et Chrysler.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Hoja de difusión Mopar par VIN — Etiqueta du guardabarros et codes de fabricación", description: "Comment décoder una hoja de difusión Mopar par VIN: la etiqueta du guardabarros, le numéro SO, les codes de vente, les codes de peinture et tapicería, et la hoja de difusión original pour véhicules Dodge, Plymouth et Chrysler.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-06-12", dateModified: "2026-06-25" };
