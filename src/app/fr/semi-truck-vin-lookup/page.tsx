...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title, description: "Décode n’importe quel VIN de tractor semi ou remolque gratuit — année, motor, GVWR et planta. Cada constructor Clase 8. Instantané.", images: [`${SITE}/semi-truck-vin-lookup/opengraph-image`] },
  robots: { index: true, follow: true },
};

const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Recherche VIN de camion semirremolque", url: PAGE_URL, applicationCategory: "AutomotiveApplication", operatingSystem: "All", description: "Herramienta gratuit pour décoder n’importe quel VIN de camion semirremolque ou remolque — Freightliner, Peterbilt, Kenworth, Volvo, Mack, International — pour trouver la marque, année modelo, motor, Clase GVWR et planta de ensamblaje.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
