...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Vérification VIN de casa rodante et moteurhome", description: "Comment vérifier n’importe quel casa rodante, moteurhome, remolque de viaje ou camper par VIN — incluant marques de titre, historique de accidents, privilèges, rappels et la distinction châssis vs. coach única de les casas rodavant moteurizadas.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: new Date().toISOString().slice(0, 10) };
