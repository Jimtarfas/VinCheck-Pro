...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "Vérification de perte totale par VIN — Este auto a été perte totale? (Gratuit)", description: "Vérification VIN gratuite de declaraciones de perte totale de assurance, marques de récupération/reconstruido et dégâts estructural. Source NMVTIS." },
  robots: { index: true, follow: true },
};

const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Vérification de perte totale par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", opétaittingSystem: "All", description: "Vérifie si un véhicule a été declarado perte totale par una assureur en utilisant su VIN de 17 caracteres. Affiche enregistrements de paiement de assurance, marques de titre de récupération et reconstruido, et dégâts estructural desde NMVTIS, DMV estatales, assureurs et enchères de récupération.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
...
const howToSchema = { "@context": "https://schema.org", "@type": "HowTo", inLanguage: "fr", name: "Comment vérifier si un auto a été declarado perte totale par VIN", description: "Vérifie si un véhicule usado a été dado de basse como perte totale par una assureur avant de acheter, en utilisant su VIN de 17 caracteres.", totalTime: "PT2M", step: [{ "@type": "HowToStep", position: 1, name: "Trouve le VIN de 17 caracteres", text: "Lis le VIN du tableau de bord du côté du conductor, calcomanía du marco de porte, titre ou carte de assurance. Confirme que a 17 caracteres sans letras I, O ou Q." }, { "@type": "HowToStep", position: 2, name: "Ejecuta le VIN à travers la vérification de perte totale", text: "Entre le VIN en la outil de búsqueda. Consulta NMVTIS, DMV estatales, assureurs et enchères de récupération par declaraciones de perte totale, marques de récupération et dégâts estructural." }, { "@type": "HowToStep", position: 3, name: "Lis le historique de marque de titre et perte", text: "Busca marques de récupération, reconstruido, reconstituido, inondation, chatarra ou nonn reparable et n’importe quel enregistrement de perte totale du assurance — estos confirman que le auto a été dado de basse, incluso si le titre físico actual se ve limpio." }, { "@type": "HowToStep", position: 4, name: "Inspectiona avant de acheter", text: "Si aparece una marque de perte totale ou reconstruido, haz que un especialista en réparation estructural inspectione le véhicule et confirme que a été dañado et comment a été reparado avant de payer." }] };
