...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Décodeur VIN de auto classique — Identification de véhicules anteriores a 1981", description: "Comment décoder VINs de voitures classiques et vintage anteriores a 1981, incluant façontos spécifiques par fabricante de GM, Ford, Chrysler et AMC, et comment vérifier la authenticité de numéros coincidents.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-25" };
