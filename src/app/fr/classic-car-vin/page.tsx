...
const description = "Décode VINs de voitures classiques et vintage anteriores a 1981 gratuit. Entiende les façontos VIN de GM, Ford, Chrysler et AMC, vérifie numéros coincidents et documenta especificaciones originales de usine avant de acheter.";

export const metadata: Metadata = {
  title: { absolute: title },
  description,
  keywords: ["décodeur VIN auto classique", "VIN auto vintage", "décodage VIN anterior a 1981", "recherche VIN auto antiguo", "VIN véhicule antiguo", "vérification VIN numéros coincidents"],
...
const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Décodeur VIN de auto classique", url: PAGE_URL, applicationCategory: "AutomotiveApplication", operatingSystem: "All", description: "Décode un véhicule classique ou vintage par su VIN. Entiende les façontos de fabricavant anteriores a 1981 de GM, Ford, Chrysler et AMC, et vérifie la authenticité de numéros coincidents.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Décodeur VIN de auto classique — Identification de véhicules anteriores a 1981", description: "Comment décoder VINs de voitures classiques et vintage anteriores a 1981, incluant façontos spécifiques par fabricante de GM, Ford, Chrysler et AMC, et comment vérifier la authenticité de numéros coincidents.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: new Date().toISOString().slice(0, 10) };
