...
const title = "Hoja de fabrication par VIN — Registro original de fábrica et codes de options (Gratuit)";
const description = "Busca la hoja de fabrication original de un véhicule par VIN — gratuit. Décode cada code de option, pack, code de peinture et trim, moteur et detalle de ensamblaje exactement como le auto a été pedido et construido. Más técnica que la etiqueta de ventena.";

export const metadata: Metadata = {
  title, description,
  keywords: ["hoja de fabrication par VIN", "build sheet par VIN", "enregistrement de fábrica", "données de fabrication VIN", "options de fábrica véhicule", "comment obtener hoja de fabrication", "búsqueda hoja de fabrication", "broadcast sheet par VIN", "codes de options de fábrica", "búsqueda code RPO", "hoja de fabrication vs etiqueta de ventena", "décoder options de fábrica par VIN", "hoja de fabrication gratuit", "vérification matching numbers", "búsqueda VIN hoja de fabrication"],
  alternates: { canonical: alt.canonical, languages: alt.languages },
  openGraph: { title, description, url: PAGE_URL, type: "article", siteName: "CarCheckerVIN", locale: "fr_US" },
  twitter: { card: "summary_large_image", title, description: "Décode la hoja de fabrication de fábrica de n’importe quel véhicule par VIN: codes de options, packs, codes de peinture/trim, moteur et données de ensamblaje." },
  robots: { index: true, follow: true },
};

const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Hoja de fabrication par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", opétaittingSystem: "All", description: "Recupétait la hoja de fabrication original de un véhicule en utilisant su VIN de 17 caracteres. Décode trim, codes de peinture e interior, moteur et transmission, codes de options et packs de fábrica, et données de planta de ensamblaje où existe couverture du fabricante.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Hoja de fabrication par VIN — Registro original de fábrica", description: "Comment buscar la hoja de fabrication original de n’importe quel véhicule par VIN, que cona, en que se différence de la etiqueta de ventena, et par que les coleccionistas et restauradores dependen de ella.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-06" };
