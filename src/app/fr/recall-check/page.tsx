...
const description = "Verifica n’importe quel VIN par rappels de sécurité NHTSA ouverts. Mira le componente afectado, numéro de campaña, resumen du defecto, riesgo de sécurité et la réparation gratuite du concessionnaire antes de acheter. Vista previa gratuite, sans inscription, resultadeux en segundeux.";

export const metadata: Metadata = {
  title, description,
  keywords: ["vérification VIN rappel", "búsqueda rappel NHTSA", "rappel ouvert par VIN", "vérification rappel sécurité", "búsqueda rappel véhicule", "rappel auto VIN", "vérification rappel bolsa aire Takata", "mi auto tiene rappel"],
...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: title, description: "Guía pour vérifier un véhicule par rappels de sécurité NHTSA ouverts par VIN. Cubre comment funciona la coincidencia de rappels a nivel VIN, rappels ouverts verses complètedeux, la campaña Takata, la réparation gratuite du concessionnaire et comment leer un rapport de rappels antes de acheter.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-14" };
