...
export const INFO_HOOKS_ES: Record<string, InfoHook> = {
  ...
  about: {
    ...
    keywords: ["CarCheckerVIN à propos de", "quies somos VIN", "historia CarCheckerVIN", "empresa rapports auto"],
    badge: "Quies somos",
    intro:
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Notre prioridad es la transparencia: n’importe quel VIN se décode gratuit avec données básicos du véhicule. Les rapports premium avec historique complet cuestan $14.99 — una fracción de le que cobran Carfax ($44.99) et AutoCheck ($24.99) par la même infaçoption.",
        ],
      },
      {
        heading: "Notre misión",
        paragraphs: [
          "Cada année, les acheteurs de voitures d’occasion en EE. UU. pierden plus de mille millelions de dólares par fraude de odomètre, marques de titre ocultas et voitures volés según la NHTSA et le NICB. La infaçoption existe — est en bases fedétaitles et de assureurs — pero le accès ha été cher et opaco.",
          "Existimos pour nivelar la cancha: infaçoption complète, precio justo, sans trucos de vente cruzada ni cuotas mensueles. Si compras un auto sans vérifier le VIN, asumois un risque innécessaire que cuesta segundeux evitar.",
        ],
      },
      {
        heading: "En quies confiamos",
        paragraphs: [
          "Opétaitmos avec données de a éténtes fedétaitles et autorizadas: le Sistema Nacional du Titre de Vehículos (NMVTIS) du Departamento de Justicia, la Administration Nacional de Sécurité du Tráfico en Carretétaits (NHTSA), le National Insurance Crime Bureau (NICB), DMVs estatales et archivos de fabricavant (Toyota, Ford, Honda, GM, BMW, Mercedes-Benz et plus de 30 marques).",
  ...
  contact: {
    ...
    metaDescription:
      "Contáctanonns par correo, teléfononn ou formulario. Support 24/7 pour rapports VIN, reembolsos et questions sur données du historique de véhicule.",
    keywords: ["contact CarCheckerVIN", "soporte VIN français", "aide rapport auto", "teléfononn CarCheckerVIN"],
    badge: "Estamos pour aiderte",
    intro:
      "Necesitas aide avec un rapport VIN, un reembolso ou una question sur les données? Contáctanonns par n’importe quela de les canales asous. Répondons correos en moins de 24 heures, normalement plus rapide.",
    sections: [
      {
        heading: "Correo electrónico",
        paragraphs: [
          "Support genétaitl et técnico: contact@carcheckervin.com",
          "Para reembolsos, inclut en le correo: le VIN consultant, la fecha de la compra et la razón. Traitons reembolsos según nonntre politique en /fr/politica-de-reembolso (100% de reembolso si nonn trouvons données pour le VIN).",
        ],
      },
      {
        heading: "Teléfononn",
      ...
      },
      {
        ...
        paragraphs: [
          "El widget de chat en la esquina inferior derecha du sitio te conecta avec nonntre équipe durante heurerio laboral. Fuétait de heurerio le chat queda registrado et répondons par correo al jour siguiente hábil.",
        ],
      },
      {
        heading: "Para reportar fraude ou véhicules volés",
        paragraphs: [
          "Si descouvres que le véhicule que verificaste aparece reportado como volé en NICB, NO completes la compra et reporta le cas a la policía local llamando al 911 (o nonn-emergencia local). NICB nonn accepte rapports directement du público — toujours va à travers la policía.",
        ],
      },
    ],
    cta: {
  ...
  help: {
    ...
    metaDescription:
      "Guías étape a étape, réponses a questions fréquentes et soporte técnico. Apprends a usar ta rapport VIN, recupétaitr ta cuenta ou solicitar un reembolso.",
    keywords: ["aide CarCheckerVIN", "FAQ VIN français", "soporte rapport auto", "comment usar rapport VIN"],
    badge: "Guías et réponses",
    intro:
      "Trouve réponses a les questions plus comunes sur revisiones VIN, rapports premium, cuentas et reembolsos. Si nonn encuentras le que buscas, contáctanonns en /fr/contact.",
    sections: [
      {
      ...
      },
      {
        heading: "Reembolsos",
        paragraphs: [
          "Offrons 100% de reembolso si nonn trouvons données du historique pour le VIN consultant (par ejemplo, voitures pre-1981 ou quelqu’unns véhicules privadeux sans historique reportado). Le reembolso se procesa en 3–5 jours hábiles a la carte original.",
  ...
  press: {
    ...
    metaDescription:
      "Infaçoption pour periodistas et médias. Datos sur la industria de historique de véhicule, données fedétaitles NMVTIS et CarCheckerVIN. Contact de presse.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "• Approximativement le 40% de les voitures d’occasion a la vente han état en al menonns un accident reportado.",
          "• Carfax estima que 358,000 véhicules a étéron dañadeux par inondation en Florida tras le huracán Ian (2022).",
        ],
      },
      {
  ...
  reviews: {
    ...
    intro:
      "Más de 50,000 acheteurs han usado nonntrois rapports VIN. Les avis en Trustpilot son verificadas — cada avis a URL pública que peuts lire en le sitio de Trustpilot directement, nonn es testimonio editado par nonnsotros.",
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Peuts lire todas nonntrois avis en Trustpilot directement: busca \"CarCheckerVIN\" en trustpilot.com.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Paquetes prepaiements desde 10 rapports (descuento progresivo). Concesionarios avec flujos hauts (50+ rapports/mois) reciben pricing personnelizado — contáctanonns en dealers@carcheckervin.com.",
        ],
      },
      {
        heading: "Intégration API",
        paragraphs: [
          "API REST pour integrar rapports VIN en ta DMS (Dealer Management System), CRM ou platafaçon de listadeux. Cada llamada devuelve JSON estructurado avec données NMVTIS, NHTSA, NICB et données du fabricante. Documentation et claves de API disponibles sous solicitud.",
        ],
      },
      {
        heading: "Rapports en lote",
        paragraphs: [
          "Sube un CSV avec múltiples VIN et reçois un rapport consolidéo du inventerio complet. Ideal pour auditorías mensueles, due diligence de compra al par mayor ou eévaluation de enchères.",
        ],
      },
    ],
    cta: {
  ...
  trust: {
    ...
    intro:
      "Tomamos en êtreio la sécurité de tes données et paiements. Esta página detalla comment protégeons ta infaçoption, nonnus respectons avec la ley fedétaitl et aseguramos que jamais vendamos tes données.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Toda communication entre ta navegador et nonntrois êtrevidores utilise chiffrement TLS 1.3 (HTTPS). Les données almacenadeux en nonntre base estn encriptadeux en reposo. Les rapports VIN guardadeux en ta cuenta son accesibles seul par ti tras authentification.",
        ],
      },
      {
        heading: "Conformité DPPA et confidentialité",
        paragraphs: [
          "Nous respectons estrictamente avec la ley fedétaitl Driver's Privacy Protection Act (18 U.S.C. § 2721). Les consultatioptiontioptiontioptions par plaque NUNCA devuelven nonnmbre, adresse, teléfononn ni données personneles du propriétaire — seul données du véhicule. Les données VIN se entregan tal como existen en bases fedétaitles et de fabricavant.",
          "No vendons, alquilamos ni partageons ta correo ou données de cuenta avec troisièmes. Lis la politique complète en /fr/confidentialité.",
        ],
      },
      {
  ...
  glossary: {
    ...
    intro:
      "Diccionario de conditions du historique de véhicule en français. Quand leas un rapport VIN ou un anuncio de vente et veas un términonn técnico que nonn entiendes, búscalo ici.",
    sections: [
      {
        ...
        paragraphs: [
          ...
          "NMVTIS (National Moteur Vehicle Title Infaçoption System) — Base de données fedétaitl administrada par le Departamento de Justicia que consolida marques de titre de les 50 états. Obligatoria pour assureurs et desguazadoras desde 2009.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Rebuilt title — Vehículo previamente salvage que a été reparado, inspectionado et devuelto a la carretétait. Pierde 20–40% de valeur de revente vs titre limpio.",
          "Junk title — Vehículo destinado a desguace, nonn peut volver a la carretétait légalement.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "DPPA (Driver's Privacy Protection Act) — Loi fedétaitl que prohíbe revelar données personneles du propriétaire en consultatioptiontioptiontioptions par plaque.",
  ...
  "obd2-codes": {
    ...
    intro:
      "Les codes OBD-II (On-Board Diagnonnstics II) son les codes de falla estndar que ta auto reporta a través du puerto OBD-II (obligatorio en EE. UU. desde 1996). Esta section décode les codes plus comunes et explica ouintomas, causas et coûts típicos de réparation.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Si la luz de Check Engine est encendida ou le OBD reporta codes activos, esto significa que le auto NO pasará la inspection de emisiones en beaucoups états (CA, NY, MA, NJ, etc.). Le vendeur peut haber apayedo la luz temporalmente avec un scanner — pero le code volverá tras 50–100 millelas.",
          "Pide al vendeur un escaneo OBD-II actualizado ou prend ta propio scanner ($30–$100 en Amazon) a ver le auto. Es la outil de diagnóstico plus rapide et bon marché pour detectar problemas mecánicos avant de acheter.",
        ],
      },
    ],
  },
  ...
  tools: {
    ...
    intro:
      "Catálogo complet de outils gratuit pour acheteurs, vendeurs et propriétaires de véhicules. Cada outil es de uso ilimitado sans besoin de cuenta.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Etiqueta Monroney par VIN (/fr/etiqueta-monroney), code de peinture (/fr/codigo-de-peinture), búsqueda par plaque (/fr/buscar-por-plaque), comparar voitures (/fr/comparar-autos), checklist de inspection (/fr/checklist-inspection-auto-usado).",
        ],
      },
    ],
  },
  ...
  disclaimer: {
    ...
    metaDescription:
      "Aviso legal de CarCheckerVIN. Limitaciones de garantie, alcance de les données NMVTIS et desfrais. Versión canónica en inglés.",
    keywords: ["mentions légales CarCheckerVIN", "disclaimer français", "limitaciones rapport VIN"],
    badge: "Documento legal",
    intro:
      "Esta página es un resumen en français du mentions légales complet. Le documento canónico — le que aplica légalement — es la versión en inglés en /disclaimer. En cas de discrepancia entre le français et le inglés, la versión en inglés prevalece.",
    sections: [
      {
        heading: "Alcance de les données",
        paragraphs: [
          "CarCheckerVIN entrega données du historique de véhicule cruzadeux de a éténtes oficiales (NMVTIS, NHTSA, NICB) et archivos de fabricavant. Les données reflejan le que est reportado a esas a éténtes — nonn garantizamos exhaustividad (quelqu’unns eventos peutn nonn haber été reportadeux a NMVTIS par la entité reportante).",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "El rapport es infaçontivo et NO sestituye la inspection física, asesoría legal ni vérification profesional de mecánica.",
        ],
      },
      {
        heading: "Politique de remboursement",
        paragraphs: [
          "Offrons 100% de reembolso si nonn trouvons données du historique pour le VIN consultant. Lis la politique complète en /fr/politica-de-reembolso.",
        ],
      },
    ],
    cta: {
  ...
  privacy: {
    ...
    metaDescription:
      "Comment collectons, utilisons et protégeons tes données. Conformité DPPA, sans vente de données, chiffrement TLS. Versión canónica en inglés.",
    keywords: ["politique confidentialité CarCheckerVIN", "privacy policy français", "DPPA français"],
    badge: "Tu confidentialité importa",
    intro:
      "Resumen en français de nonntre politique de confidentialité. La versión canónica legal es la inglesa en /privacy. En cas de discrepancia, la versión inglesa prevalece.",
    sections: [
      {
        heading: "Que données collectons",
        paragraphs: [
          "Quand usas le sitio collectons: le VIN ou plaque que consultatioptiontioptiontioptions, ta correo (si compras un rapport premium ou creas cuenta), données de paiement procesadeux par Stripe (NUNCA almacenamos ta numéro de carte), et données analíticos básicos (página visitada, navegador, país). Non collectons données personneles adicionales sans ta autorisation explícita.",
        ],
      },
      {
        heading: "Comment utilisons tes données",
        paragraphs: [
          "Nous utilisons ta correo pour entregar le rapport que compraste, enviarte le enlace de accès a ta cuenta y, ocasionalmente, nonnvedades du êtrevice (peuts darte de basse en n’importe quel momento). NUNCA vendons, alquilamos ni partageons ta correo avec troisièmes pour marketing.",
        ],
      },
      {
        heading: "Conformité DPPA",
        paragraphs: [
          "Sous la ley fedétaitl Driver's Privacy Protection Act (18 U.S.C. § 2721), les consultatioptiontioptiontioptions par plaque NUNCA devuelven données personneles du propriétaire — seul données du véhicule. Nous respectons esta ley estrictamente.",
        ],
      },
      {
        heading: "Cookies",
  ...
  terms: {
    ...
    metaDescription:
      "Conditions de uso de CarCheckerVIN. Licence de uso, limitaciones, propriété intelectual, juridiction. Versión canónica en inglés.",
    keywords: ["conditions CarCheckerVIN français", "terms of êtrevice français", "condiciones de uso VIN"],
    badge: "Documento legal",
    intro:
      "Resumen en français de les conditions et condiciones. La versión canónica legal es la inglesa en /terms. En cas de discrepancia, la versión inglesa prevalece.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "CarCheckerVIN te concede una licence personnel, nonn transferible, nonn exclusiva pour usar le êtrevice. Les rapports compradeux son pour ta uso personnel — nonn peutn être revendideux ni republicadeux publiquement sans autorisation par escrito.",
        ],
      },
      {
        heading: "Limitaciones de responsabilidad",
        paragraphs: [
          "CarCheckerVIN nonn es responsable par decisiones de compra basadas uniquement en le rapport. Toujours recomendamos complementar avec inspection mecánica profesional. Les données provienen de a éténtes oficiales pero peutn tener errores ou être incomplets.",
        ],
      },
      {
        heading: "Juridiction",
  ...
  "refund-policy": {
    ...
    metaDescription:
      "100% de reembolso si nonn trouvons données pour le VIN. Proceso simple par correo, sans questions innécessaires. Versión canónica en inglés.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Si compras un rapport premium ($14.99 ou pack prepayedo) et le rapport vuelve sans données du historique pour le VIN consultant, offrons 100% de reembolso. Esto peut ocurrir con: voitures pre-1981 (avant du estndar VIN de 17 caracteres), quelqu’unns véhicules privadeux que jamais tuvieron historique reportado, ou VINs inválideux.",
        ],
      },
      {
        heading: "Comment solicitar reembolso",
        paragraphs: [
          "Envía un correo a contact@carcheckervin.com con: le VIN consultant, la fecha de la compra et una breve description du problema. Traitons reembolsos en 3–5 jours hábiles a la carte original. Non hacemos questions innécessaires ni intentamos retenerte avec descuentos.",
        ],
      },
      {
        heading: "Cass nonn cubiertos par reembolso",
        paragraphs: [
  ...
  research: {
    ...
    intro:
      "Esta página agrupa nonntrois rapports de recherche públicos sur fraude du véhicule, marques de titre, rappels et données du sector. Recursos ouverts pour periodistas, investigadores académicos et regucôtéres.",
    sections: [
      {
