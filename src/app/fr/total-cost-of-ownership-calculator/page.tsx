...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: "Agrega la marque/modèle, tipo de véhicule, prix de compra, enganche, APR et plazo du prêt. La calculateur oba automatiquement le prix de essence et le taxe de vente de ta état.",
    },
    {
      "@type": "HowToStep",
      position: 3,
      name: "Agrega assurance, MPG et nivel de entretien",
      text: "Utilise una devis réel de assurance quand sea possible. Define le MPG desde la étiquette de la ventena de la EPA. Elige entretien Sous/Promedio/Haut selon la réputation de fiabilité du véhicule.",
    },
    {
      "@type": "HowToStep",
      position: 4,
      name: "Opcionalmente agrega le Vehículo B pour comparar",
      text: "Active le panneau de comparaison pour ver deux véhicules côte à côte. La calculateur affiche un analyse du point d’équilibre si un véhicule cuesta plus par adelantado pero a coûts opétaittivos plus souss.",
    },
    {
      "@type": "HowToStep",
      position: 5,
