...
export const GUIDE_HOOKS_ES: Record<string, SpecialtyHook> = {
  "what-is-a-vin": {
    ...
    metaDescription:
      "Guide complet de qué es un VIN, comment se compone, dónde trouverlo et qué revela. Apprends a leer et vérifier le VIN de n’importe quel auto avant de acheter.",
    keywords: [
      "qué es un VIN",
      "numéro VIN français",
    ...
    intro:
      "El VIN (Vehicle Identification Number — Número de Identification Vehicular) es un code unique de 17 caracteres asignado a cada véhicule desde 1981. Cada carácter codifica information específica: país de origen, fabricante, tipo de véhicule, moteur, année modelo, planta de ensamblaje et numéro de production. Es como la huella digital du auto.",
    whatYouGet: [
      ...
      "Diferencias entre VIN modernonns et pre-1981",
      "Validation du VIN avec dígito vérificateur (9º carácter)",
      "Lugares físicos donde est le VIN en le auto",
    ...
    trustNote:
      "El estndar VIN de 17 caracteres es definido par ISO 3779 et administrado par la NHTSA. Las posiciones específicas et su décodage estn documentadas en le code fedétaitl 49 CFR Part 565.",
  ...
  "how-to-read-a-vin": {
    ...
    h1: "Comment leer un VIN — Décodage carácter par carácter",
    metaTitle: "Comment leer un VIN — Décoder carácter a carácter",
    metaDescription:
      "Apprends a leer n’importe quel VIN de 17 caracteres carácter par carácter. WMI, VDS, année modelo, planta et numéro de êtreie — guide paso a paso en français.",
    keywords: [
      "comment leer VIN",
    ...
    whyItMatters: [
      ...
      "Saber leer le WMI distingue si un auto a été importado vs ensamblado en EE. UU.",
      "Útil al acheter autos de enchère donde nonn il y a rapport previo — empiezas par le VIN",
    ],
    trustNote:
  ...
  "free-vin-check": {
    ...
    metaDescription:
      "Guide complet pour ejecutar una vérification VIN gratuit en 2026. Qué inclut, qué nonn, les meilleures outils oficiales (NICB, NHTSA, NMVTIS) et cuándo pagar.",
    keywords: [
    ...
    intro:
      "Existen varias outils oficiales pour revisar un VIN sans coût: NHTSA (rappels), NICB VINCheck (vol et salvage), CarCheckerVIN (décodage complète et vista previa). Cada una a límites — esta guide explica qué obas avec cada outil, qué te fhaute et cuándo réelmente vale pagar un rapport complet.",
    whatYouGet: [
      ...
      "Cuándo un rapport gratuit basta et cuándo necesitas unonn pagado",
      "Precauciones: sitios falsos que cobran par données gratuitos",
      "Pasos exactos pour vérifier un VIN en NICB et NHTSA",
    ],
    whyItMatters: [
      "Avant de pagar, agotar les outils gratuit te peut ahorrar $10–$45",
      "Los données NICB et NHTSA son legalmente equivalentes a les de Carfax pour esos rubros",
      "Una vérification gratuit bien hecha resuelve le 80% de les casos avant de gastar",
      "Cononncer les outils oficiales evita estafas de sitios que cobran données gratuitos",
    ],
    trustNote:
      "NICB VINCheck (nicb.org/vincheck), NHTSA Recalls (nhtsa.gov/rappels) et NMVTIS (vehiclehistory.bja.ojp.gov) son a éténtes fedétaitles gratuites. Sus conditions de uso permiten consultationtiontiontiontiontions personales sans restricciones.",
  ...
  "vin-decoding-master-guide": {
    ...
    intro:
      "Esta es la referencia complète pour décoder n’importe quel VIN de auto: estndar internacional ISO 3779, les tablas oficiales NHTSA de codes WMI par fabricante et país, la tabla histórica de années modelo (incluida la dualité 1980 vs 2010 que confunde a beaucoups), et guides prácticas pour casos de uso réeles: compra usado, import, enchère et autos classiques pre-1981.",
    whatYouGet: [
    ...
    whyItMatters: [
      "Saber décoder manualmente te protege cuando le sitio en línea est caído",
  ...
  "car-history-report-guide": {
    ...
    metaTitle: "Guía rapport historique auto — Qué inclut",
    metaDescription:
      "Qué inclut un rapport de historique de véhicule, comment leerlo, qué señales de alerta buscar et comment usarlo pour negociar le precio. Guía paso a paso.",
    keywords: [
      "guide rapport historique auto",
      "qué inclut rapport VIN",
    ...
    intro:
      "Un rapport de historique de véhicule bien hecho cona 10+ secciones: marques de titre, accidents, lecturas du odomètre, propriétaires anteriores, rappels, vol, eventos de assurance, données de enchère et plus. Esta guide te explica qué buscar en cada section, qué patrones son señales de alerta êtreias et comment usar les hallazgos pour basêtre le precio.",
    whatYouGet: [
    ...
    whyItMatters: [
      "Sin saber leer le rapport, acheter unonn es desperdiciar le dinero",
      "Los rapports mal interpretadeux llevan a malas compras ou a perder bonnes opciones",
      "Saber qué hallazgo justifica qué descuento te da poder de négociation",
      "Las aseguradoras aussi usan estos données — alinearte avec ellos protege ta couverture",
    ],
    trustNote:
      "El estndar fedétaitl NMVTIS (administrado par le Department of Justice) define qué données doitn incluir les rapports. Los proveedores comerciales agregan capas (NICB, NHTSA, données de enchère) adeplus du piso NMVTIS.",
  ...
  "used-car-buying-complete-guide": {
    ...
    trustNote:
      "Las recomendaciones siguen les prácticas publicadas par Consumer Reports, Edmunds, AAA et la FTC (Fedétaitl Trade Commission) en su guide 'Buying a Used Car'.",
  ...
  "used-car-financing-guide": {
    ...
    metaDescription:
      "Comment financiar un voiture d’occasion en 2026: dónde precalificar (banco, credit union, dealer), qué APR espétaitr par crédito, plazos ideales et errores a evitar.",
    keywords: [
    ...
    intro:
      "Financiar un voiture d’occasion mal te peut costar milleliers. Esta guide couvre comment precalificarte avant de ir al dealer (banco, credit union, prestamistas en línea como LightStream), qué APR espétaitr según ta credit score, le plazo ideal par monto du prêt, et les trucos du dealer que inflan le coût sans que te des cuenta.",
    whatYouGet: [
    ...
    whyItMatters: [
      ...
      "Los productos 'F&I' (finance & insurance) du dealer suelen être infladeux — sabes negociar",
      "Ir directo a credit union ahorra 1–2 puntos vs financiétait du dealer",
    ],
    trustNote:
      "Datos de Experian State of Auto Finance Report (Q4 2025), NerdWallet et la CFPB (Consumer Financial Protection Bureau). Los credit unions consistentemente ofrecen 1–2 puntos par desous du promedio de dealers.",
  ...
  "vehicle-fraud-prevention": {
    ...
    intro:
      "El fraude en vente de voitures d’occasion cuesta a les consumidores étatunidenses plus de $10 mille millelions al année. Los 8 fraudes plus comunes son: lavado de titre (title washing), reversión du odomètre, VIN clonado, salvage encubierto, curbstoning (dealer ilegal posando como particular), pago avec cheque falso, autos volés puestos a la vente et warranty fraud. Esta guide te affiche comment detectar cada unonn.",
    whatYouGet: [
    ...
    whyItMatters: [
      ...
      "Comprar un VIN clonado peut llevar al confiscamiento du auto sans reembolso",
      "Cononncer les tácticas te da le filtro pour descartar opciones sospechosas avant de visitar",
    ],
    trustNote:
...
export const TOOL_HOOKS_ES: Record<string, SpecialtyHook> = {
  "used-car-checklist": {
    ...
    whyItMatters: [
      "Una inspection visuelle sistemática descarta 70% de les autos problema en 15 minutes",
      "Los detalles cosméticos (gaps, peinture) revelan accidents ocultos nonn reportadeux",
  ...
  "compare-cars": {
    ...
    metaDescription:
      "Compare n’importe quel par de autos côte à côte: specs, MPG, MSRP, valeur de marché, dépréciation espétaitda, rappels et fiabilité. Gratuit instantanément.",
    keywords: [
      "comparar autos",
