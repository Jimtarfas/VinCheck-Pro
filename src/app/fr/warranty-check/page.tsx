...
export const metadata: Metadata = {
  title, description,
  keywords: ["vérification de garantie par VIN", "mi auto sigue sous garantie", "este auto est sous garantie", "búsqueda de garantie de véhicule", "vérifier garantie de auto par VIN", "vérification garantie tren motriz", "garantie defensa a defensa", "garantie CPO VIN", "vérification garantie restante", "transfert garantie fabricante", "búsqueda fecha de puesta en êtrevice", "vérification garantie batterie EV", "garantie extendida vs fabricante", "vista previa vérification garantie gratuit"],
