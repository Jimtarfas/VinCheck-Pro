...
export const SPECIALTY_HOOKS_ES: Record<string, SpecialtyHook> = {
  ...
  "golf-cart": {
    ...
    icon: CircleDashed,
    badge: "Carrito de golf · Numéro de êtreie",
  ...
  "rappel-check": {
    ...
    keywords: [
      ...
      "consultatioptiontioptiontioption rappel par VIN",
  ...
  "odometer-check": {
    ...
    metaDescription:
      "Detecta fraude de odomètre (rollback) par VIN. Compare lecturas históricas de inspectiones, enregistrement et êtrevice. Gratuit, instantanément, sans inscription.",
    keywords: [
      "fraude odomètre VIN",
  ...
  "flood-check": {
    esSlug: "/vérification-inondation",
    englishPath: "/flood-check",
    icon: Droplets,
    badge: "Dannée par inondation · NMVTIS + NICB",
    h1: "Vérification de dégâts d’inondation par VIN",
    metaTitle: "Vérification dégâts inondation gratuit par VIN",
    metaDescription:
  ...
  "accident-history-check": {
    ...
    metaDescription:
      "Consulta historique de accidents et réparations par VIN. Cruza données de DMV, assureurs et talleres. Gratuit, instantanément, sans inscription.",
    keywords: [
  ...
  "stolen-vehicle-check": {
    ...
    whyItMatters: [
      ...
      "Les VINs clonadeux son una estafa crécent — le vendeur parece legítimo pero le auto es volé",
  ...
  "hail-damage-check": {
    ...
    whyItMatters: [
      ...
      "Les réparations PDR mal hechas dejan abolladuras visibles sous luz directa du sol",
      "La peinture sur grêle se agrieta et desprende moises après",
    ],
    trustNote:
      "Les données provienen de NMVTIS, rapports de assureurs participavant et enregistrements de enchères post-tormenta de Copart e IAA. Si le véhicule a été declarado perte totale par grêle, NMVTIS le rea incluso si le titre a été lavado croisant états.",
    schemaName: "Vérification de dégâts par grêle par VIN",
  },

  "airbag-check": {
    esSlug: "/vérification-airbag",
  ...
  "total-loss-check": {
    ...
    icon: CircleSlash,
    badge: "Pérdida total · Assureurs",
    h1: "Vérification de perte totale par VIN",
    metaTitle: "Vérification perte totale gratuit par VIN",
    metaDescription:
      "Detecta si un véhicule a été declarado perte totale (total loss) par una assureur. Cruza données NMVTIS et enchères. Gratuit par VIN.",
    keywords: [
      "perte totale VIN",
      "total loss français",
      "auto declarado perte totale",
      "assureur perte totale VIN",
  ...
  "market-value": {
    ...
    metaDescription:
      "Consulta le valeur de marché réel de un auto par VIN. Cruza données KBB, NADA, Edmunds et tarifs de vente récents. Gratuit, instantanément.",
    keywords: [
  ...
  "ford-build-sheet": {
    ...
    whatYouGet: [
      ...
      "Numéro de êtreie de production Ford",
    ],
    whyItMatters: [
  ...
  "gm-build-sheet": {
    ...
    whyItMatters: [
      "Les Camaro Z/28 numbers-matching et Corvette Z06 avec pack Z51 valen $20K–$50K plus que les modificadeux",
      "Les pickups Silvétaitdo/Sierra requieren RPO pour confirmar trim Denali, High Country ou ZR2",
      "Les SUV de lujo (Escalade, Yukon Denali) usan RPO pour les packs Platinum et Premium",
  ...
  "chassis-number-lookup": {
    ...
    icon: Hash,
    badge: "Numéro de châssis · Identification",
    h1: "Recherche de numéro de châssis par VIN",
    metaTitle: "Recherche numéro de châssis gratuit par VIN",
    metaDescription:
      "Busca le numéro de châssis par VIN. Para voitures classiques, JDM, voitures europeos et motos. Décodage gratuit instantanément.",
    keywords: [
    ...
    whatYouGet: [
      ...
      "Validation de authenticité pour voitures coleccionables",
  ...
  "motorcycle-vin-search": {
    ...
    whyItMatters: [
      "Les motos estn entre les véhicules plus volés — vérifie avant de acheter",
      "Les rappels par adresse de Harley afectan milleliers de unitées par année",
      "Les motos chocadas se \"reconstruyen\" avec piezas de otras unitées — le VIN doit coincidir físicamente",
  ...
  "plate-to-vin": {
    ...
    whyItMatters: [
      "Útil quand seul as una photo du auto en una vente privada (Facebook Marketplace, Craigslist)",
      "Les plaques se peutn transferir entre véhicules — le VIN es la identité permanente",
      "Detecta voitures clonadeux (plaque válida pero VIN volé) avant de payer",
  ...
  "look-up-car-plates-free": {
    esSlug: "/consultatioptiontioptiontioptionr-plaques-gratuit",
    ...
    keywords: [
      ...
      "consultatioptiontioptiontioption du véhicule par plaque",
    ...
    whyItMatters: [
      ...
      "Confirme données du véhicule quand seul as una foto",
  ...
  "dealer-check": {
    esSlug: "/vérification-concessionnaire",
    ...
    metaDescription:
      "Vérifie réputation et licence de n’importe quel concessionnaire avant de acheter. Quejas BBB, demandas en attentes, licence DMV en vigueur — gratuit.",
    keywords: [
      "vérifier concessionnaire auto",
      "dealer check français",
      "licence DMV concessionnaire",
  ...
  "marketplace-vin-check": {
    esSlug: "/vérification-vin-marketplace",
    englishPath: "/marketplace-vin-check",
    icon: Store,
    badge: "Marketplace · Facebook, Craigslist, OfferUp",
    h1: "Vérification VIN pour voitures de marketplace",
    metaTitle: "Vérification VIN marketplace gratuit — Facebook/Craigslist",
    metaDescription:
      "Vérifie VIN de voitures vendideux en Facebook Marketplace, Craigslist, OfferUp et eBay Moteurs avant de acheter. Detecta fraude et voitures volés — gratuit.",
    keywords: [
    ...
    whyItMatters: [
      ...
      "Les voitures clonadeux (plaques/VIN copiadeux) son endémicos en marketplaces sans vérification",
      "Sin garantie de marketplace = sans recurso si descouvres salvage après de payer",
      "Una vérification de 60 segundeux par VIN previene la mayoría de estafas",
    ],
    trustNote:
      "Datos cruzadeux contra NMVTIS, NICB, NHTSA et rapports de assureurs. Les vendeurs legítimos en marketplaces toujours comparten le VIN sans objeción — si se niegan ou dan excusas, es bandétait roja crítica.",
    schemaName: "Vérification VIN pour marketplaces",
  },

  "locationl-car-check": {
    esSlug: "/vérification-auto-location",
    ...
    whatYouGet: [
      ...
      "Marcas de dégâts previo (salvage, grêle, inondation)",
      "Vérification de êtrevice récent et entretien",
    ...
    trustNote:
      "Les données du rappel provienen en temps réel de la NHTSA. Sous la ley Raechel and Jacqueline Houck Safe Rental Car Act (49 U.S.C. § 30120(j)), les locationdoras NO peutn alquilar voitures avec rappel ouvert — si le hacen, as derecho a rechazarlo et exigir reemplazo sans frais.",
    schemaName: "Vérification VIN auto de location",
  },

  "rideshare-check": {
    esSlug: "/vérification-rideshare",
    englishPath: "/rideshare-check",
    icon: Users,
    badge: "Rideshare · Uber, Lyft",
    h1: "Vérification VIN pour voitures de rideshare (Uber, Lyft)",
  ...
  "warranty-check": {
    esSlug: "/vérification-garantia",
    englishPath: "/warranty-check",
    icon: Receipt,
    badge: "Garantía en vigueur · OEM",
    h1: "Vérification de garantie OEM par VIN",
    metaTitle: "Vérification garantie auto par VIN — Gratuit OEM",
    metaDescription:
      "Vérifie si la garantie OEM de ta véhicule sigue en vigueur par VIN. Couvertures, fechas de vencimiento, kilométrage restante — gratuit instantanément.",
    keywords: [
