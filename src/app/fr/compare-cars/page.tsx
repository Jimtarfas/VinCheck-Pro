...
export const metadata: Metadata = {
  title, description,
  keywords: ["comparar autos", "outil comparaci\u00f3n autos", "comparar veh\u00edculos", "comparaci\u00f3n voitures côte à côte", "comparar deux autos", "auto vs auto", "comparar especificaciones", "comparar tarifs", "comparar MPG", "camry vs accord", "civic vs corolla", "comparaci\u00f3n gratuit autos"],
