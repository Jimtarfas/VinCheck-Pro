...
const description = "Busca una hoja de fabrication Ford, Lincoln ou Mercury par VIN, gratuit. Décode la plaque de données de la porte, code de distrito DSO, tags de eje et transmission, codes de peinture et trim, et apprends comment le Marti Report reconstruye le pedido original de fábrica pour véhicules Ford de 1967 en adelante.";

export const metadata: Metadata = {
  title, description,
  keywords: ["hoja de fabrication Ford par VIN", "décoder plaque de données porte Ford", "code DSO Ford", "Marti Report", "décoder plaque de garantie Ford", "hoja de fabrication Mustang", "code peinture et trim Ford", "code eje Ford", "hoja de fabrication Lincoln Mercury", "décodeur VIN Ford", "opciones de fábrica Ford par VIN", "buck tag Ford rotunda", "décoder opciones VIN Ford", "enregistrement de fabrication Ford"],
