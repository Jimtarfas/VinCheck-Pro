...
export const metadata: Metadata = {
  title, description,
  keywords: ["hoja de fabrication Ford par VIN", "décoder plaque de données porte Ford", "code DSO Ford", "Marti Report", "décoder plaque de garantie Ford", "hoja de fabrication Mustang", "code peinture et trim Ford", "code eje Ford", "hoja de fabrication Lincoln Mercury", "décodeur VIN Ford", "options de fábrica Ford par VIN", "buck tag Ford rotunda", "décoder options VIN Ford", "enregistrement de fabrication Ford"],
...
const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Hoja de fabrication Ford par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", opétaittingSystem: "All", description: "Recupétait un enregistrement de fabrication Ford, Lincoln ou Mercury en utilisant su VIN. Décode la plaque de données de la porte, code de distrito DSO, tags de eje et transmission, codes de peinture et trim, et données de planta de ensamblaje, et explica comment le Marti Report reconstruye le pedido original de fábrica.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
