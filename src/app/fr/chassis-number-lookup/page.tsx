...
const description = "Busca un auto par numéro de châssis gratuit. Un numéro de châssis es le même VIN de 17 caractères — decodifícalo pour trouver le tipo de auto, marque, modèle, année, moteur et historique complet. Fonctionne pour véhicules en todo le monde. Sin enregistrement.";

export const metadata: Metadata = {
  title, description,
  keywords: ["recherche numéro de châssis", "buscar auto par numéro de châssis", "trouver véhicule par numéro de châssis", "buscador de numéro de châssis", "vérifier mi numéro de châssis", "trouver mi numéro de châssis", "buscar tipo de auto par vin", "vérification numéro de châssis", "décoder numéro de châssis", "recherche décodeur VIN", "décodeur VIN gratuit en ligne", "meilleur décodeur VIN gratuit", "vérifier un auto gratuit", "que es un numéro de châssis", "numéro de châssis vs vin", "recherche numéro de bastidor de auto", "recherche numéro de châssis de véhicule"],
...
const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Recherche numéro de châssis", url: PAGE_URL, applicationCategory: "AutomotiveApplication", operatingSystem: "All", description: "Herramienta gratuit pour décoder n’importe quel numéro de châssis (VIN) et trouver le tipo de auto, marque, modèle, année, moteur et historique de véhicule complet. Fonctionne pour véhicules en todo le monde.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Recherche numéro de châssis", description: "Apprends comment buscar un auto par numéro de châssis, que significa chaque segmento du code de 17 caractères, où trouverlo par pays et comment detectar bandétaits rojas avant de acheter.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-04-16", dateModified: new Date().toISOString().slice(0, 10) };
