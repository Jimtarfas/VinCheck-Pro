...
const description = "Busca un auto par numéro de châssis gratuit. Un numéro de châssis es le même VIN de 17 caracteres — decodifícalo pour trouver le tipo de auto, marque, modelo, année, moteur et historique complet. Funciona pour véhicules en todo le mundo. Sin enregistrement.";
