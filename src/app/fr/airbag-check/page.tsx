...
const howToSchema = { "@context": "https://schema.org", "@type": "HowTo", inLanguage: "fr", name: "Comment vérifier le historique de bolsas de aire et SRS par VIN", description: "Evalúa si les bolsas de aire de un véhicule usado probablemente se se sont déployés et si le sistema SRS a été restaurado correctement, en utilisant su VIN de 17 caracteres avant de acheter.", totalTime: "PT2M", step: [{ "@type": "HowToStep", position: 1, name: "Trouve le VIN de 17 caracteres", text: "Lis le VIN du tableau de bord du côté du conductor, la calcomanía du marco de la porte, le titre ou le enregistrement. Confirme que sea de 17 caracteres sans les letras I, O ou Q." }, { "@type": "HowToStep", position: 2, name: "Ejecuta le VIN pour señales de despliegue", text: "Entre le VIN en la outil de búsqueda. Affiche enregistrements de accidents graves, perte totale de assureurs et titrois de récupération que indican despliegue probable de bolsas de aire, adeplus de n’importe quel rappel de sécurité de bolsa de aire ouvert de NHTSA." }, { "@type": "HowToStep", position: 3, name: "Señala n’importe quel despliegue sans inscription de réparation", text: "Una colisión frontal ou latétaitl grave en le historique sans un reemplazo correspondiente de bolsa de aire es una bandétait roja mayor de que le sistema SRS peut nonn haberse restaurado correctement." }, { "@type": "HowToStep", position: 4, name: "Confirme avec un escaneo diagnóstico SRS", text: "Avant de acheter, obtiens una inspection previa a la compra que lea les codes de falla SRS avec un escáner OBD-II. Jamais te bases seul en que la luz de advertencia de bolsa de aire esté apayeda — peut deshabilitarse." }] };
