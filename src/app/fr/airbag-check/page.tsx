...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Vérification de bolsas de aire et despliegue par VIN", description: "Apprends comment vérifier le historique de despliegue de bolsas de aire par VIN, par que importa, les façons comunes de fraude de bolsas de aire et comment vérifier que le sistema SRS a été restaurado correctement.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: new Date().toISOString().slice(0, 10) };
