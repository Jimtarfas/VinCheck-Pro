...
const description = "Verifica le historique de flota comercial de n’importe quel véhicule par VIN — gratuit. Encuentra ex-patrullas, véhicules de flota gubernamental, historique de taxi et propiedad de flota corporativa desde NMVTIS et les 50 enregistrements DMV estatales, antes de acheter.";

export const metadata: Metadata = {
  title, description,
  keywords: ["vérification flota VIN", "vérification ex-patrulla", "véhicule de flota anterior", "historique uso comercial VIN", "vérification véhicule gubernamental", "vérification VIN patrulla", "historique VIN auto de location", "vérification flota corporativa", "historique taxi par VIN", "búsqueda propiedad véhicule de flota", "este auto es ex-patrulla", "cadena titre flota VIN"],
  alternates: { canonical: alt.canonical, languages: alt.languages },
  openGraph: { title, description, url: PAGE_URL, type: "article", siteName: "CarCheckerVIN", locale: "fr_US" },
  twitter: { card: "summary_large_image", title, description: "Vérification gratuit basada en VIN du historique de propiedad de flota policial, gubernamental, de location, taxi et corporativa desde NMVTIS et les 50 DMV estatales." },
  robots: { index: true, follow: true },
};

const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Vérification de flota et ex-patrulla par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", operatingSystem: "All", description: "Verifica le historique de flota comercial de un véhicule par su VIN de 17 caracteres. Muestra propiedad de flota policial, gubernamental, de location, taxi et corporativa desde NMVTIS et les 50 enregistrements DMV estatales de cadena de titre.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Vérification de flota et ex-patrulla par VIN", description: "Aprende comment vérifier le historique de flota comercial par VIN, incluyendo ex-patrullas, véhicules gubernamentales et enregistrements de flota de alto uso.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-25" };
