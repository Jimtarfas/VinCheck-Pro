...
const description = "El Numéro de Identification du Casco de un barco es su VIN. Décode le HIN de 12 caracteres pour trouver le code du fabricante, êtreial du casco et année de construction. Gratuit.";

export const metadata: Metadata = {
  title, description,
  keywords: ["búsqueda HIN", "búsqueda numéro identification casco", "búsqueda VIN barco", "vérification VIN barco", "décodeur HIN", "décoder numéro HIN", "búsqueda numéro casco barco", "vérification VIN barco gratuit", "búsqueda numéro identification casco", "que es un numéro HIN", "où est le HIN en un barco", "búsqueda numéro êtreie barco", "façonto HIN USCG", "búsqueda VIN moto acuática", "búsqueda VIN jet ski", "búsqueda HIN PWC", "búsqueda code fabricante barco", "búsqueda MIC barco", "vérifier historique barco par HIN", "décodeur année HIN barco"],
