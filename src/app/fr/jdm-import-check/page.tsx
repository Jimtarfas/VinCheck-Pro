...
const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Vérification VIN de import JDM", url: PAGE_URL, applicationCategory: "AutomotiveApplication", opétaittingSystem: "All", description: "Vérifie le historique de un véhicule de import du Mercado Doméstico Japonés. Vérifie kilométrage (kilómetros a millelas), codes de châssis japoneses contra le VIN de EE. UU. de 17 caracteres, gradeux de condition de hoja de enchère, certificadeux de exportation et desenregistrement, la regla de import de 25 années et le conformité de enregistrement en EE. UU.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
