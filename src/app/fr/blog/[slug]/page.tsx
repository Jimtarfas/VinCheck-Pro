 ...
 * seoTitleEs, seoDescriptionEs) with English fallback. If a post has non
...
// `DYNAMIC_SERVER_USAGE` at request time → every /fr/blog/<slug>
// returned 500. The English /blog/[slug] doesn't hit this because
// Sanity's draftMode integration there marks it dynamic implicitly.
