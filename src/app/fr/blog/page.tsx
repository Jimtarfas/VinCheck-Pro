...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Guides expertas en compra de voitures d’occasion, décodage VIN, historique de véhicule, marques de titre et prévention de fraude. Datos NMVTIS, NICB et NHTSA.",
    keywords: [
    ...
    openGraph: {
      ...
      description:
        "Guides expertas en compra de voitures d’occasion, VIN, historique de véhicule et prévention de fraude.",
      url: `${SITE}/fr/blog`,
      type: "website",
      locale: "fr_US",
    },
