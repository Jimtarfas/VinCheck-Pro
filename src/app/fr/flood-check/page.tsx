...
const title = "Vérification de dégâts d’inondation par VIN — Cette voiture a-t-elle été inonnndée ? (Recherche gratuite de dégâts des eaux)";
const description = "Vérifie n’importe quel auto par dégâts d’inondation avec le VIN — gratuit. Affiche marques de titre par inondation et dégâts des eaux, enregistrements de récupération par huracán et declaraciones de perte totale du assurance de NMVTIS, DMV estatales et enchères de récupération avant de acheter un véhicule dañado par agua.";

export const metadata: Metadata = {
  title, description,
  keywords: ["vérification dégâts inondation VIN", "historique auto inundado", "vérification dégâts agua VIN", "vérification titre inondation", "este auto a été inonnndé", "vérifier auto par dégâts inondation par VIN", "dégâts huracán véhicule", "titre récupération par inondation", "marque titre dégâts agua", "vérification véhicule inundado gratuit", "titre inondation NMVTIS", "lavado titre auto inundado"],
  alternates: { canonical: alt.canonical, languages: alt.languages },
  openGraph: { title, description, url: PAGE_URL, type: "article", siteName: "CarCheckerVIN", locale: "fr_US" },
  twitter: { card: "summary_large_image", title, description: "Vérification VIN gratuite pour marques de titre par inondation et dégâts des eaux, récupération par huracán et total-loss. Source NMVTIS." },
  robots: { index: true, follow: true },
};

const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Vérification de dégâts d’inondation par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", opétaittingSystem: "All", description: "Vérifie si un véhicule a été dañado par inondation en utilisant su VIN de 17 caracteres. Affiche marques de titre par inondation et dégâts des eaux, enregistrements de récupération par huracán et declaraciones de perte totale du assurance de NMVTIS, DMV estatales, assureurs et enchères de récupération.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Vérification de dégâts d’inondation par VIN — Cette voiture a-t-elle été inonnndée ?", description: "Comment vérifier n’importe quel véhicule par historique de inondation et dégâts des eaux en utilisant le VIN, que significa una marque de titre par inondation, comment detectar un auto inundado oculto et comment les enregistrements de inondation llegan a un rapport VIN.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-08" };
