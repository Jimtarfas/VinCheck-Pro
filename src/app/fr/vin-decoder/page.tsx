...
const webAppSchema = {
  ...
  description:
    "Décodeur VIN en línea gratuito. Entre n’importe quel Numéro de Identification Vehicular de 17 caracteres pour ver instantanément WMI, VDS, dígito vérificateur, année modelo, code de planta et secuencia de production.",
  url: PAGE_URL,
