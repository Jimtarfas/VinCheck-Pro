...
const description =
  "Haz una verificaci\u00f3n gratuit de VIN pour n’importe quel moto, crucero, deportiva ou moto todoterreno. Décode le VIN de 17 caracteres pour obtener historique complet, état du t\u00edtulo, enregistrements de vol et especificaciones.";
