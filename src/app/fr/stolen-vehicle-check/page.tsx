...
export const metadata: Metadata = {
  title, description,
  keywords: ["vérification véhicule volé", "este auto est volé", "vérification VIN auto volé", "vérifier si auto est volé par VIN", "búsqueda véhicule volé NICB", "vérification VIN volé gratuit", "reportar auto volé VIN", "búsqueda base données voitures volés", "titre récupération de vol", "vérification VIN clonado"],
