...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: title, description: "Comment vérifier si un véhicule est volé en utilisant su VIN: que couvren les bases de données NICB et NMVTIS, les signaux de avertissement de un auto volé et que hacer si un VIN est marque.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-04-16", dateModified: "2026-06-13" };
