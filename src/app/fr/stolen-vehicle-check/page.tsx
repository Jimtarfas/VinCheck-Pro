...
export const metadata: Metadata = {
  title, description,
  keywords: ["vérification véhicule volé", "este auto est volé", "vérification VIN auto volé", "vérifier si auto est volé par VIN", "búsqueda véhicule volé NICB", "vérification VIN volé gratuit", "reportar auto volé VIN", "búsqueda base données autos volés", "titre récupération de vol", "vérification VIN clonado"],
...
const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Vérification de véhicule volé par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", opétaittingSystem: "All", description: "Vérifie si un véhicule est reportado como volé par su VIN. Consulta les enregistrements de vol et récupération de NICB VINCheck et les marques de titre de NMVTIS de les 50 DMV estatales, mostrando indicadores activos de vol, récupération de vol et récupération avant de la compra.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: title, description: "Comment vérifier si un véhicule est volé usando su VIN: qué couvren les bases de données NICB et NMVTIS, les señales de advertencia de un auto volé et qué hacer si un VIN est marqué.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-04-16", dateModified: "2026-06-13" };
