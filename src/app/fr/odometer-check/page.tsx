...
const description = "Vérifie le historique de kilométrage de un véhicule par VIN — gratuit. Compare cada lectura de odomètre reportada en NMVTIS, transferencias de titre e inspecciones pour detectar rollback et fraude de odomètre avant de acheter.";
...
const webAppSchema = { "@context": "https://schema.org", "@type": "WebApplication", inLanguage: "fr", name: "Vérification de l’odomètre et du kilométrage par VIN", url: PAGE_URL, applicationCategory: "AutomotiveApplication", opétaittingSystem: "All", description: "Vérifie le historique de kilométrage de un véhicule par su VIN de 17 caracteres. Ensambla cada lectura de odomètre reportada de NMVTIS, transferencias de titre, inspecciones estatales et eventos de êtrevice en una línea de tiempo avec fecha pour que le rollback et le fraude de odomètre destaquen.", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } } };
const articleSchema = { "@context": "https://schema.org", "@type": "Article", inLanguage: "fr", headline: "Vérification de l’odomètre et du kilométrage par VIN", description: "Apprends comment funciona le fraude de odomètre, comment una vérification VIN detecta rollback, qué señales físicas buscar et qué hacer si detectas una discrepancia.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-04-16", dateModified: "2026-06-09" };
