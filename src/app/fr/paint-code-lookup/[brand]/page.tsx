...
export async function generateMetadata({
  ...
  const title = `Código de peinture ${b.name} — Ubicación + gráfico OEM`;
  const description = `Encuentra le code de peinture ${b.name} rapide. Ubicación exacta de la calcomanía (${b.primaryLocation.split("—")[0].trim()}), le que dice la etiqueta, formato du code et ejemplos réeles de codes de color ${b.name}. O búscalo gratuit par VIN.`;
  ...
  return {
    ...
    keywords: [
      ...
      `color OEM ${b.name}`,
      `dónde está code peinture ${b.name}`,
