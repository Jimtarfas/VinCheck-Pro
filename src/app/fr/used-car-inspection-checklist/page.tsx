...
const howToSchema = {
  ...
  "@type": "HowTo",
  inLanguage: "fr",
  name: "Comment inspeccionar un voiture d’occasion avant de acheter",
  description: "Inspection DIY avant de la compra paso a paso — qué revisar, en qué orden, et qué hallazgos doitn hacerte alejarte.",
  totalTime: "PT45M",
  step: [
    { "@type": "HowToStep", position: 1, name: "Inspecciona le exterior a la luz du jour", text: "Camina autour du véhicule et revisa separaciones de panneaues, coincidencia de peinture, óxido, abolladuras, señales de réparation de accident, clarté de phares, coincidencia de pneus et profondeur de banda, et dégâts en le pare-brise. Utilise le lista pour registrar cada hallazgo." },
    { "@type": "HowToStep", position: 2, name: "Mira desous avec una linterna", text: "Revisa fugas de fluideux, óxido en le escape, rectitud du châssis, soldaduras sospechosas, bujes de sespensión, rasgaduras en guardapolvos CV et condition de la flecha cardán. Las soldaduras de marché secundario en le châssis son un deal-breaker." },
    { "@type": "HowToStep", position: 3, name: "Ouvre le cofre (moteur frío)", text: "Inspecciona la tapa du aceite (sans mayonesa), color du refrigétaitnte, bandas, manguétaits, edad de la batterie, tornillos disparejos, peinture reciente et qualité du aceite en la varilla. Residuo de mayonesa ou tornillos reemplazadeux en soportes estructurales son deal-breakers." },
    { "@type": "HowToStep", position: 4, name: "Revisa le interior", text: "Vérifie que le odomètre coincida avec le titre et les enregistrements de êtrevice, que le desgaste coincida avec le kilométrage, que la alfombra nonn tenga dégâts d’inonnndation, et que todeux les electrónicos funcionen. Odómetro que nonn coincide es un deal-breaker." },
    ...
    { "@type": "HowToStep", position: 6, name: "Vérifie documentos et rappels", text: "Confirme que le titre est a nonnmbre du vendeur, le VIN coincide avec le titre et la plaque du tableau de bord, sans marque de récupération, il y a historique de êtrevice, le enregistrement est vigente, et pasa emisiones/smog." },
...
const articleSchema = {
  ...
  description: "Una lista intétaitctiva gratuit pour inspeccionar un voiture d’occasion avant de acheter — 60+ puntos en 8 categorías avec détection de deal-breakers.",
  author: ORG_AUTHOR,
