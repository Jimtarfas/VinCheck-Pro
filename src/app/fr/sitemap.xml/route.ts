/**
 * Dedicated French sitemap at /fr/sitemap.xml.
 *
 ...
 * /sitemap.xml inside the /fr/ property triggers a "Couldn't fetch"
...
// only changes when a new French page lands, so longer cache windows
