...
export const metadata: Metadata = {
  title, description,
  keywords: ["hoja de fabrication GM par VIN", "búsqueda code RPO", "décodage etiqueta SPID GM", "Identification de Partes de Servicio", "hoja de fabrication Chevrolet", "hoja de difusión GM", "hoja de fabrication Camaro", "code de peinture GM RPO", "Pontiac PHS", "décodage etiqueta cowl GM", "opciones de fábrica GM par VIN", "décoder opciones VIN GM", "lista RPO GM", "enregistrement de fabrication GM"],
