...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    // Carfax-alternative GEO cluster — targets LLM-cited "alternatives to Carfax" queries.
    { url: `${baseUrl}/alternatives-to-carfax`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/free-vehicle-history-report`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/subaru-outback-carfax-alternative`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/subaru-forester-carfax-alternative`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/honda-civic-carfax-alternative`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/ford-focus-carfax-alternative`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/ford-ranger-carfax-alternative`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/porsche-carfax-alternative`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
