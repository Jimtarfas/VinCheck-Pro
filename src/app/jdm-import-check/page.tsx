...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: "JDM Import VIN Check — Japanese Import Vehicle History", description: "How to check the history of Japanese Domestic Market import vehicles: mileage verification in kilometers, chassis codes versus the 17-character VIN, Japanese auction sheets, the 25-year import rule, and US compliance status.", author: ORG_AUTHOR, publisher: { "@type": "Organization", name: "CarCheckerVIN", url: SITE, logo: { "@type": "ImageObject", url: `${SITE}/logo.png` } }, mainEntityOfPage: { "@type": "WebPage", "@id": PAGE_URL }, datePublished: "2026-05-04", dateModified: "2026-06-25" };
