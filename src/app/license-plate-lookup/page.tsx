...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "DPPA plate lookup",
    "license plate lookup by vin",
    "vin number lookup license plate",
    "vin license plate lookup",
    "lookup tag number by vin",
    "vin to license plate lookup",
    "license plate lookup vin",
    "plate lookup by vin",
    "license plate number lookup from vin",
    "vin number plate lookup",
    "plate vin lookup",
    "license plate vin number lookup",
    "lookup plate number by vin",
    "vin and license plate lookup",
    "vin or license plate lookup",
    "license plate lookup using vin",
    "vin number lookup with license plate",
    "plate number lookup by vin",
    "vin lookup by tag",
    "vin to license plate lookup free",
  ],
  alternates: {
