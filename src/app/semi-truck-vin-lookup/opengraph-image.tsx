    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Freightliner, Peterbilt, Kenworth, Volvo, Mack &amp; semi trailers —
            17 characters to year, engine &amp; plant.
          </div>
        </div>

        <div style={{ display: "flex", gap: 16, fontSize: 22, flexWrap: "wrap" }}>
          {["Tractors + Trailers", "All Class 8 Builders", "17 Characters", "Free"].map(
            (t) => (
              <div
                key={t}
                style={{
